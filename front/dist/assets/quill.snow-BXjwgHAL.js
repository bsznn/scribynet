...
var zo = (r, t, e) =>
	t in r
		? Ho(r, t, { enumerable: !0, configurable: !0, writable: !0, value: e })
		: (r[t] = e);
var q = (r, t, e) => zo(r, typeof t != "symbol" ? t + "" : t, e);
...
var Ml =
	...
	te = Ml || Ko || Function("return this")(),
	ve = te.Symbol,
	Dl = Object.prototype,
	Go = Dl.hasOwnProperty,
	Vo = Dl.toString,
	_n = ve ? ve.toStringTag : void 0;
function Wo(r) {
	var t = Go.call(r, _n),
		e = r[_n];
	try {
	...
	var s = Vo.call(r);
	return n && (t ? (r[_n] = e) : delete r[_n]), s;
}
...
function hi(r) {
	if (!Ee(r)) return !1;
	var t = hn(r);
	return t == ea || t == na || t == ta || t == ra;
}
var _s = te["__core-js_shared__"],
	Ii = (() => {
...
function fi(r, t, e) {
	t == "__proto__" && Sr
		? Sr(r, t, { configurable: !0, enumerable: !0, value: e, writable: !0 })
		: (r[t] = e);
}
function zn(r, t) {
	return r === t || (r !== r && t !== t);
...
function $l(r, t, e) {
	var n = r[t];
	(!(qa.call(r, t) && zn(n, e)) || (e === void 0 && !(t in r))) && fi(r, t, e);
}
function Ca(r, t, e, n) {
	var s = !e;
	e || (e = {});
	for (var i = -1, o = t.length; ++i < o; ) {
		var a = t[i],
			u = void 0;
		u === void 0 && (u = r[a]), s ? fi(e, a, u) : $l(e, a, u);
	}
	return e;
}
var ki = Math.max;
function Ia(r, t, e) {
	return (
		(t = ki(t === void 0 ? r.length - 1 : t, 0)),
		function () {
			for (
				var n = arguments, s = -1, i = ki(n.length - t, 0), o = Array(i);
				++s < i;
			)
				o[s] = n[t + s];
			s = -1;
			for (var a = Array(t + 1); ++s < t; ) a[s] = n[s];
			return (a[t] = e(o)), ba(r, this, a);
		}
	);
}
function Ra(r, t) {
	return xa(Ia(r, t, jl), r + "");
}
var ka = 9007199254740991;
function Ul(r) {
	return typeof r == "number" && r > -1 && r % 1 == 0 && r <= ka;
}
function Cr(r) {
	return r != null && Ul(r.length) && !hi(r);
}
function Ba(r, t, e) {
	if (!Ee(e)) return !1;
	var n = typeof t;
	return (n == "number" ? Cr(e) && Pl(t, e.length) : n == "string" && t in e)
		? zn(e[t], r)
		: !1;
}
function Ma(r) {
	return Ra((t, e) => {
		var n = -1,
			...
			o = s > 2 ? e[2] : void 0;
		for (
			i = r.length > 3 && typeof i == "function" ? (s--, i) : void 0,
				o && Ba(e[0], e[1], o) && ((i = s < 3 ? void 0 : i), (s = 1)),
				t = Object(t);
			++n < s;
		) {
			var a = e[n];
...
function di(r) {
	var t = r && r.constructor,
		e = (typeof t == "function" && t.prototype) || Da;
	return r === e;
}
function ja(r, t) {
...
var Fl = Object.prototype,
	$a = Fl.hasOwnProperty,
	Ua = Fl.propertyIsEnumerable,
	Hs = Bi((() => arguments)())
		? Bi
		: (r) => le(r) && $a.call(r, "callee") && !Ua.call(r, "callee");
function Fa() {
	return !1;
}
var Hl = typeof exports == "object" && exports && !exports.nodeType && exports,
	Mi = Hl && typeof module == "object" && module && !module.nodeType && module,
	Ha = Mi && Mi.exports === Hl,
	Di = Ha ? te.Buffer : void 0,
	za = Di ? Di.isBuffer : void 0,
	Dn = za || Fa,
	Ka = "[object Arguments]",
	Ga = "[object Array]",
	Va = "[object Boolean]",
...
lt[Ka] =
	...
	lt[rc] =
		!1;
function pc(r) {
	return le(r) && Ul(r.length) && !!lt[hn(r)];
}
function gi(r) {
	return (t) => r(t);
}
var zl = typeof exports == "object" && exports && !exports.nodeType && exports,
	Rn = zl && typeof module == "object" && module && !module.nodeType && module,
	mc = Rn && Rn.exports === zl,
	Os = mc && Ml.process,
	ln = (() => {
		try {
			var r = Rn && Rn.require && Rn.require("util").types;
			return r || (Os && Os.binding && Os.binding("util"));
		} catch {}
	})(),
	ji = ln && ln.isTypedArray,
	pi = ji ? gi(ji) : pc,
	bc = Object.prototype,
	yc = bc.hasOwnProperty;
function Kl(r, t) {
	var e = qe(r),
		n = !e && Hs(r),
		s = !e && !n && Dn(r),
	...
	for (var h in r)
		(t || yc.call(r, h)) &&
			!(
				...
				(h == "length" ||
					(s && (h == "offset" || h == "parent")) ||
					(i && (h == "buffer" || h == "byteLength" || h == "byteOffset")) ||
					Pl(h, u))
			) &&
			a.push(h);
	return a;
...
var vc = Gl(Object.keys, Object),
	Ec = Object.prototype,
	Ac = Ec.hasOwnProperty;
function Nc(r) {
	if (!di(r)) return vc(r);
	var t = [];
	for (var e in Object(r)) Ac.call(r, e) && e != "constructor" && t.push(e);
	return t;
}
function wc(r) {
	return Cr(r) ? Kl(r) : Nc(r);
}
function Tc(r) {
	var t = [];
...
var xc = Object.prototype,
	Lc = xc.hasOwnProperty;
function Sc(r) {
	if (!Ee(r)) return Tc(r);
	var t = di(r),
		e = [];
	for (var n in r) (n == "constructor" && (t || !Lc.call(r, n))) || e.push(n);
	return e;
}
function Vl(r) {
	return Cr(r) ? Kl(r, !0) : Sc(r);
}
var jn = ke(Object, "create");
function _c() {
...
function Rc(r) {
	...
	return Ic.call(t, r) ? t[r] : void 0;
}
var kc = Object.prototype,
	Bc = kc.hasOwnProperty;
function Mc(r) {
	var t = this.__data__;
	return jn ? t[r] !== void 0 : Bc.call(t, r);
}
...
function Ir(r, t) {
	for (var e = r.length; e--; ) if (zn(r[e][0], t)) return e;
	return -1;
}
...
function Fc(r) {
	...
	if (e < 0) return !1;
	var n = t.length - 1;
	return e == n ? t.pop() : Uc.call(t, e, 1), --this.size, !0;
}
function Hc(r) {
	var t = this.__data__,
		e = Ir(t, r);
...
Be.prototype.clear = Gc;
Be.prototype.delete = Wc;
Be.prototype.get = Zc;
Be.prototype.has = Xc;
Be.prototype.set = Yc;
function Qc(r, t) {
	for (var e = -1, n = t.length, s = r.length; ++e < n; ) r[s + e] = t[e];
	return r;
}
var Wl = Gl(Object.getPrototypeOf, Object),
	Jc = "[object Object]",
	...
	ru = Zl.call(Object);
function su(r) {
	if (!le(r) || hn(r) != Jc) return !1;
	var t = Wl(r);
	if (t === null) return !0;
	var e = nu.call(t, "constructor") && t.constructor;
	return typeof e == "function" && e instanceof e && Zl.call(e) == ru;
}
function iu() {
...
function Xt(r) {
	var t = (this.__data__ = new ce(r));
	this.size = t.size;
}
Xt.prototype.clear = iu;
Xt.prototype.delete = lu;
Xt.prototype.get = ou;
Xt.prototype.has = au;
Xt.prototype.set = uu;
var Xl = typeof exports == "object" && exports && !exports.nodeType && exports,
	Pi = Xl && typeof module == "object" && module && !module.nodeType && module,
	hu = Pi && Pi.exports === Xl,
	$i = hu ? te.Buffer : void 0,
	Ui = $i ? $i.allocUnsafe : void 0;
function Yl(r, t) {
	if (t) return r.slice();
	var e = r.length,
		n = Ui ? Ui(e) : new r.constructor(e);
	return r.copy(n), n;
}
function fu(r, t) {
...
var gu = Object.prototype,
	pu = gu.propertyIsEnumerable,
	Fi = Object.getOwnPropertySymbols,
	mu = Fi
		? (r) =>
				r == null ? [] : ((r = Object(r)), fu(Fi(r), (t) => pu.call(r, t)))
		: du;
function bu(r, t, e) {
	var n = t(r);
	return qe(r) ? n : Qc(n, e(r));
}
function zs(r) {
	return bu(r, wc, mu);
}
var Ks = ke(te, "DataView"),
	Gs = ke(te, "Promise"),
	Vs = ke(te, "Set"),
	Hi = "[object Map]",
	yu = "[object Object]",
	...
	wu = Re(Fs),
	jt = hn;
((Ks && jt(new Ks(new ArrayBuffer(1))) != Vi) ||
	(Pn && jt(new Pn()) != Hi) ||
	(Gs && jt(Gs.resolve()) != zi) ||
	(Vs && jt(new Vs()) != Ki) ||
	(Fs && jt(new Fs()) != Gi)) &&
...
function Lu(r) {
	...
	return (
		t &&
			typeof r[0] == "string" &&
			xu.call(r, "index") &&
			((e.index = r.index), (e.input = r.input)),
		e
	);
}
...
function mi(r) {
	...
	return new _r(t).set(new _r(r)), t;
}
function Su(r, t) {
	var e = mi(r.buffer);
...
var _u = /\w*$/;
function Ou(r) {
	var t = new r.constructor(r.source, _u.exec(r));
	return (t.lastIndex = r.lastIndex), t;
}
var Wi = ve ? ve.prototype : void 0,
	Zi = Wi ? Wi.valueOf : void 0;
function qu(r) {
	return Zi ? Object(Zi.call(r)) : {};
}
function Ql(r, t) {
	var e = t ? mi(r.buffer) : r.buffer;
	return new r.constructor(e, r.byteOffset, r.length);
}
var Cu = "[object Boolean]",
	Iu = "[object Date]",
	Ru = "[object Map]",
	ku = "[object Number]",
	Bu = "[object RegExp]",
...
function Jl(r) {
	return typeof r.constructor == "function" && !di(r) ? ma(Wl(r)) : {};
}
var Yu = "[object Map]";
function Qu(r) {
	return le(r) && jt(r) == Yu;
...
function Tr(r, t, e, n, s, i) {
	...
	if (u) o = Lu(r);
		...
		var h = jt(r),
			p = h == eo || h == ah;
		if (Dn(r)) return Yl(r, a);
		if (h == no || h == to || (p && !s)) o = p ? {} : Jl(r);
		else {
			if (!st[h]) return s ? r : {};
			o = Xu(r, h, a);
		}
	...
	i.set(r, o),
		nh(r)
			? r.forEach((y) => {
					o.add(Tr(y, t, e, y, r, i));
				})
			: Ju(r) &&
				r.forEach((y, A) => {
					o.set(A, Tr(y, t, e, A, r, i));
				});
	var f = zs,
		m = u ? void 0 : f(r);
	return (
		La(m || r, (y, A) => {
			m && ((A = y), (y = r[A])), $l(o, A, Tr(y, t, e, A, r, i));
		}),
		o
	);
}
...
function qh(r) {
	return this.__data__.set(r, Oh), this;
}
function Ch(r) {
	return this.__data__.has(r);
}
function Or(r) {
	var t = -1,
		e = r == null ? 0 : r.length;
	for (this.__data__ = new Be(); ++t < e; ) this.add(r[t]);
}
Or.prototype.add = Or.prototype.push = qh;
Or.prototype.has = Ch;
function Ih(r, t) {
...
function ro(r, t, e, n, s, i) {
	...
	var h = i.get(r),
		p = i.get(t);
	if (h && p) return h == t && p == r;
	var v = -1,
		f = !0,
		m = e & Bh ? new Or() : void 0;
	for (i.set(r, t), i.set(t, r); ++v < a; ) {
		var y = r[v],
			A = t[v];
		if (n) var w = o ? n(A, y, v, t, r, i) : n(y, A, v, r, t, i);
		if (w !== void 0) {
			if (w) continue;
			f = !1;
			break;
		...
		if (m) {
			if (
				!Ih(t, (x, C) => {
					if (!Rh(m, C) && (y === x || s(y, x, e, n, i))) return m.push(C);
				})
			) {
				f = !1;
				break;
...
var jh = 1,
	...
	Xh = "[object DataView]",
	Qi = ve ? ve.prototype : void 0,
	qs = Qi ? Qi.valueOf : void 0;
function Yh(r, t, e, n, s, i, o) {
	switch (e) {
		case Xh:
		...
		case Zh:
			return !(r.byteLength != t.byteLength || !i(new _r(r), new _r(t)));
		case $h:
		case Uh:
		case zh:
			return zn(+r, +t);
		...
		case Gh: {
			var u = n & jh;
			if ((a || (a = Dh), r.size != t.size && !u)) return !1;
			var h = o.get(r);
			if (h) return h == t;
			(n |= Ph), o.set(r, t);
			var p = ro(a(r), a(t), n, s, i, o);
			return o.delete(r), p;
		}
		case Wh:
			if (qs) return qs.call(r) == qs.call(t);
	}
	return !1;
}
var Qh = 1,
	Jh = Object.prototype,
	tf = Jh.hasOwnProperty;
function ef(r, t, e, n, s, i) {
	var o = e & Qh,
		a = zs(r),
		u = a.length,
		h = zs(t),
	...
	for (var v = u; v--; ) {
		var f = a[v];
		if (!(o ? f in t : tf.call(t, f))) return !1;
	}
	var m = i.get(r),
		y = i.get(t);
	if (m && y) return m == t && y == r;
	var A = !0;
	i.set(r, t), i.set(t, r);
	for (var w = o; ++v < u; ) {
		f = a[v];
		var x = r[f],
			C = t[f];
		if (n) var M = o ? n(C, x, f, t, r, i) : n(x, C, f, r, t, i);
...
var nf = 1,
	...
	gr = "[object Object]",
	rf = Object.prototype,
	el = rf.hasOwnProperty;
function sf(r, t, e, n, s, i) {
	var o = qe(r),
		a = qe(t),
		u = o ? tl : jt(r),
		h = a ? tl : jt(t);
	(u = u == Ji ? gr : u), (h = h == Ji ? gr : h);
	var p = u == gr,
		v = h == gr,
		f = u == h;
	if (f && Dn(r)) {
	...
	if (f && !p)
		return (
			i || (i = new Xt()),
			o || pi(r) ? ro(r, t, e, n, s, i) : Yh(r, t, u, e, n, s, i)
		);
	if (!(e & nf)) {
		var m = p && el.call(r, "__wrapped__"),
			y = v && el.call(t, "__wrapped__");
		if (m || y) {
			var A = m ? r.value() : r,
				w = y ? t.value() : t;
			return i || (i = new Xt()), s(A, w, e, n, i);
		}
	}
	return f ? (i || (i = new Xt()), ef(r, t, e, n, s, i)) : !1;
}
function so(r, t, e, n, s) {
	return r === t
		? !0
		: r == null || t == null || (!le(r) && !le(t))
			? r !== r && t !== t
			: sf(r, t, e, n, so, s);
}
function lf(r) {
...
var of = lf();
function Ws(r, t, e) {
	((e !== void 0 && !zn(r[t], e)) || (e === void 0 && !(t in r))) &&
		fi(r, t, e);
}
function af(r) {
	return le(r) && Cr(r);
					...
					: af(a)
						...
						: m
							...
							: y
								...
								: (p = [])
				: su(u) || Hs(u)
					? ((p = a), Hs(a) ? (p = cf(a)) : (!Ee(a) || hi(a)) && (p = Jl(u)))
					: (v = !1);
	}
	v && (o.set(u, p), s(p, u, n, i, o), o.delete(u)), Ws(r, e, p);
}
function io(r, t, e, n, s) {
	r !== t &&
		of(
			t,
			(i, o) => {
				if ((s || (s = new Xt()), Ee(i))) uf(r, t, o, e, io, n, s);
				else {
					var a = n ? n(Zs(r, o), i, o + "", r, t, s) : void 0;
					a === void 0 && (a = i), Ws(r, o, a);
				}
			},
			Vl,
		);
...
var ye = Ma((r, t, e) => {
	...
	D = ((r) => (
		...
		(r[(r.INLINE = 7)] = "INLINE"),
		(r[(r.BLOCK = 11)] = "BLOCK"),
		(r[(r.BLOCK_BLOT = 10)] = "BLOCK_BLOT"),
		(r[(r.INLINE_BLOT = 6)] = "INLINE_BLOT"),
		(r[(r.BLOCK_ATTRIBUTE = 9)] = "BLOCK_ATTRIBUTE"),
		(r[(r.INLINE_ATTRIBUTE = 5)] = "INLINE_ATTRIBUTE"),
		(r[(r.ANY = 15)] = "ANY"),
		r
	))(D || {});
class Qt {
	constructor(t, e, n = {}) {
		...
		(this.scope = n.scope != null ? (n.scope & D.LEVEL) | s : D.ATTRIBUTE),
...
const lo = class Xs {
	...
	static find(t, e = !1) {
		...
		if (Xs.blots.has(t)) return Xs.blots.get(t) || null;
		if (e) {
			let n = null;
			try {
				n = t.parentNode;
	...
	create(t, e, n) {
		...
		if (s == null) throw new rn(`Unable to create ${e} blot`);
		const i = s,
			o = e instanceof Node || e.nodeType === Node.TEXT_NODE ? e : i.create(n),
			a = new i(t, o, n);
			...
			typeof t == "string"
				...
				: t instanceof Text || t.nodeType === Node.TEXT_NODE
					...
					: typeof t == "number"
						? t & D.LEVEL & D.BLOCK
							? (n = this.types.block)
							: t & D.LEVEL & D.INLINE && (n = this.types.inline)
						: t instanceof Element &&
							((t.getAttribute("class") || "")
								.split(/\s+/)
								.some((s) => ((n = this.classes[s]), !!n)),
							(n = n || this.tags[t.tagName])),
			n == null
				? null
				: "scope" in n && e & D.LEVEL & n.scope && e & D.TYPE & n.scope
					? n
					: null
		);
	}
	register(...t) {
		return t.map((e) => {
			const n = "blotName" in e,
				s = "attrName" in e;
			if (!n && !s) throw new rn("Invalid definition");
			...
			return (
				(this.types[i] = e),
				s
					? typeof e.keyName == "string" && (this.attributes[e.keyName] = e)
					: n &&
						(e.className && (this.classes[e.className] = e),
						e.tagName &&
							(Array.isArray(e.tagName)
								? (e.tagName = e.tagName.map((o) => o.toUpperCase()))
								: (e.tagName = e.tagName.toUpperCase()),
							(Array.isArray(e.tagName) ? e.tagName : [e.tagName]).forEach(
								(o) => {
									(this.tags[o] == null || e.className == null) &&
										(this.tags[o] = e);
								},
							))),
				e
...
lo.blots = new WeakMap();
const on = lo;
function nl(r, t) {
	return (r.getAttribute("class") || "")
		.split(/\s+/)
...
class hf extends Qt {
	...
	remove(t) {
		nl(t, this.keyName).forEach((e) => {
			t.classList.remove(e);
		}),
			t.classList.length === 0 && t.removeAttribute("class");
	}
	value(t) {
		const e = (nl(t, this.keyName)[0] || "").slice(this.keyName.length + 1);
...
class ff extends Qt {
	...
	add(t, e) {
		return this.canAdd(t, e) ? ((t.style[Cs(this.keyName)] = e), !0) : !1;
	}
	remove(t) {
		(t.style[Cs(this.keyName)] = ""),
			t.getAttribute("style") || t.removeAttribute("style");
	}
	value(t) {
		const e = t.style[Cs(this.keyName)];
		return this.canAdd(t, e) ? e : "";
	}
}
const Ae = ff;
class df {
	...
	build() {
		...
		if (t == null) return;
		const e = Qt.keys(this.domNode),
			n = Ft.keys(this.domNode),
			s = Ae.keys(this.domNode);
		e.concat(n)
			.concat(s)
			.forEach((i) => {
...
const kr = df,
	oo = class {
		...
		static create(t) {
			if (this.tagName == null) throw new rn("Blot definition missing tagName");
			let e, n;
			return (
				Array.isArray(this.tagName)
					? (typeof t == "string"
							...
							: typeof t == "number" && (n = t),
						typeof n == "number"
							? (e = document.createElement(this.tagName[n - 1]))
							: n && this.tagName.indexOf(n) > -1
								? (e = document.createElement(n))
								: (e = document.createElement(this.tagName[0])))
		...
		formatAt(t, e, n, s) {
			...
			if (this.scroll.query(n, D.BLOT) != null && s) i.wrap(n, s);
		...
		insertAt(t, e, n) {
			const s =
					n == null ? this.scroll.create("text", e) : this.scroll.create(e, n),
				i = this.split(t);
			this.parent.insertBefore(s, i || void 0);
		}
		isolate(t, e) {
			const n = this.split(t);
			if (n == null) throw new Error("Attempt to isolate at end");
			return n.split(e), n;
		}
		length() {
			return 1;
...
oo.blotName = "abstract";
const ao = oo;
const co = class extends ao {
	static value(t) {
		return !0;
	}
	index(t, e) {
...
class pf {
	...
	forEachAt(t, e, n) {
		...
		for (; u && o < t + e; ) {
			const h = u.length();
			t > o
				? n(u, t - o, Math.min(e, o + h - t))
				: n(u, 0, Math.min(h, t + e - o)),
				(o += h),
				(u = a());
		}
	}
...
function rl(r, t) {
	...
	try {
		...
		return (
			...
			r.parentNode && r.parentNode.replaceChild(n.domNode, r),
			n.attach(),
			n
		);
	}
}
const uo = class de extends ao {
	constructor(t, e) {
	...
	attachUI(t) {
		this.uiNode != null && this.uiNode.remove(),
			(this.uiNode = t),
			de.uiClass && this.uiNode.classList.add(de.uiClass),
			this.uiNode.setAttribute("contenteditable", "false"),
			this.domNode.insertBefore(this.uiNode, this.domNode.firstChild);
	}
	build() {
		(this.children = new pf()),
			Array.from(this.domNode.childNodes)
				.filter((t) => t !== this.uiNode)
				.reverse()
				.forEach((t) => {
					try {
						const e = rl(t, this.scroll);
						this.insertBefore(e, this.children.head || void 0);
					} catch (e) {
						if (e instanceof rn) return;
						throw e;
					}
				});
	}
	deleteAt(t, e) {
		if (t === 0 && e === this.length()) return this.remove();
	...
	descendants(t, e = 0, n = Number.MAX_VALUE) {
		let s = [],
			i = n;
		return (
			this.children.forEachAt(e, n, (o, a, u) => {
				((t.blotName == null && t(o)) ||
					(t.blotName != null && o instanceof t)) &&
					s.push(o),
					o instanceof de && (s = s.concat(o.descendants(t, a, i))),
					(i -= u);
			}),
			s
		);
	...
	enforceAllowedChildren() {
		...
		this.children.forEach((e) => {
			t ||
				this.statics.allowedChildren.some((n) => e instanceof n) ||
				(e.statics.scope === D.BLOCK_BLOT
					? (e.next != null && this.splitAfter(e),
	...
	path(t, e = !1) {
		const [n, s] = this.children.find(t, e),
			i = [[this, t]];
	...
	replaceWith(t, e) {
		const n = typeof t == "string" ? this.scroll.create(t, e) : t;
		return n instanceof de && this.moveChildren(n), super.replaceWith(n);
	}
	split(t, e = !1) {
		if (!e) {
			if (t === 0) return this;
	...
	splitAfter(t) {
		const e = this.clone();
		for (; t.next != null; ) e.appendChild(t.next);
	...
	update(t, e) {
		...
		t.forEach((i) => {
			i.target === this.domNode &&
				i.type === "childList" &&
				(n.push(...i.addedNodes), s.push(...i.removedNodes));
		}),
			s.forEach((i) => {
				if (
					i.parentNode != null &&
...
function bf(r, t) {
	...
	for (const e in r) if (r[e] !== t[e]) return !1;
	return !0;
}
const Xe = class Ye extends $t {
	static create(t) {
		return $t.create(t);
	}
	static formats(t, e) {
		const n = e.query(Ye.blotName);
		if (!(n != null && t.tagName === n.tagName)) {
			if (typeof Ye.tagName == "string") return !0;
			if (Array.isArray(Ye.tagName)) return t.tagName.toLowerCase();
		}
	}
	constructor(t, e) {
		super(t, e), (this.attributes = new kr(this.domNode));
	}
	format(t, e) {
		if (t === this.statics.blotName && !e)
			this.children.forEach((n) => {
				n instanceof Ye || (n = n.wrap(Ye.blotName, !0)),
	...
	formatAt(t, e, n, s) {
		this.formats()[n] != null || this.scroll.query(n, D.ATTRIBUTE)
			? this.isolate(t, e).format(n, s)
	...
	update(t, e) {
		super.update(t, e),
			t.some((n) => n.target === this.domNode && n.type === "attributes") &&
				this.attributes.build();
	}
	wrap(t, e) {
		const n = super.wrap(t, e);
		return n instanceof Ye && this.attributes.move(n), n;
	}
};
(Xe.allowedChildren = [Xe, Et]),
	(Xe.blotName = "inline"),
	(Xe.scope = D.INLINE_BLOT),
	(Xe.tagName = "SPAN");
const yf = Xe;
const bi = yf,
	Qe = class Ys extends $t {
		static create(t) {
			return $t.create(t);
		}
		static formats(t, e) {
			const n = e.query(Ys.blotName);
			if (!(n != null && t.tagName === n.tagName)) {
				if (typeof Ys.tagName == "string") return !0;
				if (Array.isArray(Ys.tagName)) return t.tagName.toLowerCase();
			}
		}
		constructor(t, e) {
			super(t, e), (this.attributes = new kr(this.domNode));
		...
		formatAt(t, e, n, s) {
			this.scroll.query(n, D.BLOCK) != null
				? this.format(n, s)
				: super.formatAt(t, e, n, s);
		}
		insertAt(t, e, n) {
...
(Qe.blotName = "block"),
	(Qe.scope = D.BLOCK_BLOT),
	(Qe.tagName = "P"),
	(Qe.allowedChildren = [bi, Qe, Et]);
const vf = Qe;
const $n = vf,
	Qs = class extends $t {
		checkMerge() {
...
(Qs.blotName = "container"), (Qs.scope = D.BLOCK_BLOT);
const Ef = Qs;
const Br = Ef;
class Af extends Et {
	static formats(t, e) {}
	...
	Je = class extends $t {
		constructor(t, e) {
			super(null, e),
				...
				this.observer.observe(this.domNode, Nf),
				this.attach();
		}
		create(t, e) {
		...
		optimize(t = [], e = {}) {
			...
			const i = (u, h = !0) => {
					u == null ||
						u === this ||
						(u.domNode.parentNode != null &&
							(n.has(u.domNode) || n.set(u.domNode, []), h && i(u.parent)));
				},
				o = (u) => {
					n.has(u.domNode) &&
						(u instanceof $t && u.children.forEach(o),
						n.delete(u.domNode),
						u.optimize(e));
				};
			let a = t;
				...
				for (
					a.forEach((h) => {
						...
						p != null &&
							(p.domNode === h.target &&
								(h.type === "childList"
									? (i(this.find(h.previousSibling, !1)),
										Array.from(h.addedNodes).forEach((v) => {
...
(Je.blotName = "scroll"),
	(Je.defaultChild = $n),
	(Je.allowedChildren = [$n, Br]),
	(Je.scope = D.BLOCK_BLOT),
	(Je.tagName = "DIV");
const Tf = Je;
const yi = Tf,
	Js = class ho extends Et {
		static create(t) {
		...
		update(t, e) {
			t.some((n) => n.type === "characterData" && n.target === this.domNode) &&
				(this.text = this.statics.value(this.domNode));
		}
		value() {
			return this.text;
...
(Js.blotName = "text"), (Js.scope = D.INLINE_BLOT);
const xf = Js;
const qr = xf,
	Lf = Object.freeze(
...
function Sf() {
	...
	function n(g, L, b, O, S) {
		...
		var I = s(g, L);
		return k && I.unshift([e, k]), j && I.push([e, j]), C(I, S), O && v(I), I;
	}
	function s(g, L) {
		var b;
		if (!g) return [[t, L]];
		if (!L) return [[r, g]];
		var O = g.length > L.length ? g : L,
			S = g.length > L.length ? L : g,
			T = O.indexOf(S);
		if (T !== -1)
			return (
				(b = [
					[t, O.substring(0, T)],
					[e, S],
					[t, O.substring(T + S.length)],
				]),
				g.length > L.length && (b[0][0] = b[2][0] = r),
				b
			);
		if (S.length === 1)
			return [
	...
	function i(g, L) {
		...
		(k[T + 1] = 0), (j[T + 1] = 0);
		for (
			var K = b - O, F = K % 2 !== 0, V = 0, W = 0, $ = 0, it = 0, ot = 0;
			ot < S;
			ot++
		) {
			for (var G = -ot + V; G <= ot - W; G += 2) {
				var Q = T + G,
					Y;
				G === -ot || (G !== ot && k[Q - 1] < k[Q + 1])
					? (Y = k[Q + 1])
					: (Y = k[Q - 1] + 1);
				for (var J = Y - G; Y < b && J < O && g.charAt(Y) === L.charAt(J); )
					Y++, J++;
				if (((k[Q] = Y), Y > b)) W += 2;
				else if (J > O) V += 2;
				else if (F) {
					...
					if (et >= 0 && et < _ && j[et] !== -1) {
						var nt = b - j[et];
						if (Y >= nt) return o(g, L, Y, J);
					}
				}
			}
			for (var ct = -ot + $; ct <= ot - it; ct += 2) {
				var et = T + ct,
					nt;
				ct === -ot || (ct !== ot && j[et - 1] < j[et + 1])
					? (nt = j[et + 1])
					: (nt = j[et - 1] + 1);
				for (
					var mt = nt - ct;
					nt < b && mt < O && g.charAt(b - nt - 1) === L.charAt(O - mt - 1);
				)
					nt++, mt++;
				if (((j[et] = nt), nt > b)) it += 2;
				else if (mt > O) $ += 2;
				else if (!F) {
					var Q = T + K - ct;
					if (Q >= 0 && Q < _ && k[Q] !== -1) {
						var Y = k[Q],
							J = T + Y - Q;
						if (((nt = b - nt), Y >= nt)) return o(g, L, Y, J);
					}
				}
			}
		}
	...
	function a(g, L) {
		if (!g || !L || g.charAt(0) !== L.charAt(0)) return 0;
		for (var b = 0, O = Math.min(g.length, L.length), S = O, T = 0; b < S; )
			g.substring(T, S) == L.substring(T, S) ? ((b = S), (T = b)) : (O = S),
	...
	function u(g, L) {
		var b = g.length,
			O = L.length;
		if (b == 0 || O == 0) return 0;
		b > O ? (g = g.substring(b - O)) : b < O && (L = L.substring(0, b));
		var S = Math.min(b, O);
		if (g == L) return S;
		for (var T = 0, _ = 1; ; ) {
			var k = g.substring(S - _),
				j = L.indexOf(k);
			if (j == -1) return T;
			(_ += j),
				(j == 0 || g.substring(S - _) == L.substring(0, _)) && ((T = _), _++);
		}
	}
	function h(g, L) {
		if (!g || !L || g.slice(-1) !== L.slice(-1)) return 0;
		for (var b = 0, O = Math.min(g.length, L.length), S = O, T = 0; b < S; )
			g.substring(g.length - S, g.length - T) ==
			L.substring(L.length - S, L.length - T)
				? ((b = S), (T = b))
				: (O = S),
				(S = Math.floor((O - b) / 2 + b));
	...
	function p(g, L) {
		var b = g.length > L.length ? g : L,
			O = g.length > L.length ? L : g;
		if (b.length < 4 || O.length * 2 < b.length) return null;
		function S(W, $, it) {
			for (
				var ot = W.substring(it, it + Math.floor(W.length / 4)),
					G = -1,
					Q = "",
					Y,
					J,
				...
				var ct = a(W.substring(it), $.substring(G)),
					mt = h(W.substring(0, it), $.substring(0, G));
				Q.length < mt + ct &&
					((Q = $.substring(G - mt, G) + $.substring(G, G + ct)),
					(Y = W.substring(0, it - mt)),
					(J = W.substring(it + ct)),
					(et = $.substring(0, G - mt)),
					(nt = $.substring(G + ct)));
			}
			return Q.length * 2 >= W.length ? [Y, J, et, nt, Q] : null;
		}
		var T = S(b, O, Math.ceil(b.length / 4)),
			_ = S(b, O, Math.ceil(b.length / 2)),
			k;
		if (!T && !_) return null;
		_ ? (T ? (k = T[4].length > _[4].length ? T : _) : (k = _)) : (k = T);
		var j, I, K, F;
		g.length > L.length
			? ((j = k[0]), (I = k[1]), (K = k[2]), (F = k[3]))
			: ((K = k[0]), (F = k[1]), (j = k[2]), (I = k[3]));
		var V = k[4];
		return [j, I, K, F, V];
	}
	function v(g) {
		for (
			var L = !1, b = [], O = 0, S = null, T = 0, _ = 0, k = 0, j = 0, I = 0;
			T < g.length;
		)
			g[T][0] == e
				? ((b[O++] = T), (_ = j), (k = I), (j = 0), (I = 0), (S = g[T][1]))
				: (g[T][0] == t ? (j += g[T][1].length) : (I += g[T][1].length),
					S &&
						S.length <= Math.max(_, k) &&
						S.length <= Math.max(j, I) &&
						(g.splice(b[O - 1], 0, [r, S]),
						(g[b[O - 1] + 1][0] = t),
						O--,
						O--,
						(T = O > 0 ? b[O - 1] : -1),
		...
		for (L && C(g), x(g), T = 1; T < g.length; ) {
			if (g[T - 1][0] == r && g[T][0] == t) {
				var K = g[T - 1][1],
					...
					W = u(F, K);
				V >= W
					? (V >= K.length / 2 || V >= F.length / 2) &&
						(g.splice(T, 0, [e, F.substring(0, V)]),
						(g[T - 1][1] = K.substring(0, K.length - V)),
						(g[T + 1][1] = F.substring(V)),
						T++)
					: (W >= K.length / 2 || W >= F.length / 2) &&
						(g.splice(T, 0, [e, K.substring(0, W)]),
						(g[T - 1][0] = t),
						(g[T - 1][1] = F.substring(0, F.length - W)),
						(g[T + 1][0] = r),
						(g[T + 1][1] = K.substring(W)),
						T++),
					T++;
			}
			T++;
			...
			if (g[b - 1][0] == e && g[b + 1][0] == e) {
				...
				if (_) {
					...
					(O = O.substring(0, O.length - _)),
						(S = k + S.substring(0, S.length - _)),
						(T = k + T);
				}
				for (
					var j = O, I = S, K = T, F = L(O, S) + L(S, T);
					S.charAt(0) === T.charAt(0);
				) {
					(O += S.charAt(0)),
						(S = S.substring(1) + T.charAt(0)),
						(T = T.substring(1));
					var V = L(O, S) + L(S, T);
					V >= F && ((F = V), (j = O), (I = S), (K = T));
				}
				g[b - 1][1] != j &&
					(j ? (g[b - 1][1] = j) : (g.splice(b - 1, 1), b--),
					(g[b][1] = I),
					K ? (g[b + 1][1] = K) : (g.splice(b + 1, 1), b--));
			}
			b++;
		}
	}
	function C(g, L) {
		g.push([e, ""]);
		for (var b = 0, O = 0, S = 0, T = "", _ = "", k; b < g.length; ) {
				...
				case e: {
					...
					if (L) {
						if (j >= 0 && rt(g[j][1])) {
							...
							if (
								...
								g.splice(j, 1), b--;
								var K = j - 1;
								g[K] && g[K][0] === t && (S++, (_ = g[K][1] + _), K--),
									g[K] && g[K][0] === r && (O++, (T = g[K][1] + T), K--),
									(j = K);
							}
						}
						if (U(g[b][1])) {
					...
					if (T.length > 0 || _.length > 0) {
						T.length > 0 &&
							...
							k !== 0 &&
								(j >= 0
									? (g[j][1] += _.substring(0, k))
									: (g.splice(0, 0, [e, _.substring(0, k)]), b++),
								(_ = _.substring(k)),
								(T = T.substring(k))),
							(k = h(_, T)),
							k !== 0 &&
								((g[b][1] = _.substring(_.length - k) + g[b][1]),
								(_ = _.substring(0, _.length - k)),
								(T = T.substring(0, T.length - k))));
						var F = S + O;
						T.length === 0 && _.length === 0
							? (g.splice(b - F, F), (b = b - F))
							: T.length === 0
								? (g.splice(b - F, F, [t, _]), (b = b - F + 1))
								: _.length === 0
									? (g.splice(b - F, F, [r, T]), (b = b - F + 1))
									: (g.splice(b - F, F, [r, T], [t, _]), (b = b - F + 2));
					}
					b !== 0 && g[b - 1][0] === e
						? ((g[b - 1][1] += g[b][1]), g.splice(b, 1))
						: b++,
						(S = 0),
						(O = 0),
						(T = ""),
		...
		for (b = 1; b < g.length - 1; )
			g[b - 1][0] === e &&
				g[b + 1][0] === e &&
				(g[b][1].substring(g[b][1].length - g[b - 1][1].length) === g[b - 1][1]
					? ((g[b][1] =
							g[b - 1][1] +
							g[b][1].substring(0, g[b][1].length - g[b - 1][1].length)),
						(g[b + 1][1] = g[b - 1][1] + g[b + 1][1]),
						g.splice(b - 1, 1),
						(V = !0))
					: g[b][1].substring(0, g[b + 1][1].length) == g[b + 1][1] &&
						((g[b - 1][1] += g[b + 1][1]),
						(g[b][1] = g[b][1].substring(g[b + 1][1].length) + g[b + 1][1]),
						g.splice(b + 1, 1),
						(V = !0))),
				b++;
		V && C(g, L);
	...
	function Rt(g, L, b) {
		var O = typeof b == "number" ? { index: b, length: 0 } : b.oldRange,
			S = typeof b == "number" ? null : b.newRange,
			T = g.length,
			_ = L.length;
		if (O.length === 0 && (S === null || S.length === 0)) {
			var k = O.index,
				j = g.slice(0, k),
				I = g.slice(k),
				K = S ? S.index : null;
			...
			t: {
				if (K !== null && K !== k) break t;
				var Y = k,
					V = L.slice(0, Y),
					W = L.slice(Y);
				if (V !== j) break t;
				var J = Math.min(T - Y, _ - Y),
					et = I.slice(I.length - J),
					nt = W.slice(W.length - J);
				if (et !== nt) break t;
				var G = I.slice(0, I.length - J),
					Q = W.slice(0, W.length - J);
				return ft(j, G, Q, et);
			}
		}
		if (O.length > 0 && S && S.length === 0)
			t: {
				var it = g.slice(0, O.index),
					et = g.slice(O.index + O.length),
					$ = it.length,
					J = et.length;
				if (_ < $ + J) break t;
				var ot = L.slice(0, $),
					nt = L.slice(_ - J);
				if (it !== ot || et !== nt) break t;
				var G = g.slice($, T - J),
					Q = L.slice($, _ - J);
				return ft(it, G, Q, et);
			}
	...
	return (xt.INSERT = t), (xt.DELETE = r), (xt.EQUAL = e), (Is = xt), Is;
}
var qn = { exports: {} };
qn.exports;
var il;
			...
			((r, t) => {
				...
				(I[i] =
					...
					I[S] =
						!0),
					(I[h] = I[p] = I[z] = !1);
				var K = typeof pe == "object" && pe && pe.Object === Object && pe,
					F = typeof self == "object" && self && self.Object === Object && self,
					V = K || F || Function("return this")(),
					W = t && !t.nodeType && t,
					$ = W && !0 && r && !r.nodeType && r,
					it = $ && $.exports === W;
				function ot(l, c) {
				...
				function J(l, c, d, E) {
					for (var H = -1, P = l ? l.length : 0; ++H < P; )
						d = c(d, l[H], H, l);
					return d;
				}
				function et(l, c) {
					for (var d = -1, E = Array(l); ++d < l; ) E[d] = c(d);
					return E;
				}
				function nt(l, c) {
				...
				var $r = Array.prototype,
					...
					Ne = it ? V.Buffer : void 0,
					Ue = V.Symbol,
					gn = V.Uint8Array,
					St = fn(Object.getPrototypeOf, Object),
					Qn = Object.create,
					Jn = Pe.propertyIsEnumerable,
					Hr = $r.splice,
					pn = Object.getOwnPropertySymbols,
					Fe = Ne ? Ne.isBuffer : void 0,
					tr = fn(Object.keys, Object),
					He = Bt(V, "DataView"),
					we = Bt(V, "Map"),
					kt = Bt(V, "Promise"),
					ze = Bt(V, "Set"),
					...
					vn = Nt(ze),
					En = Nt(mn),
					he = Ue ? Ue.prototype : void 0,
					er = he ? he.valueOf : void 0;
				function ee(l) {
					var c = -1,
						d = l ? l.length : 0;
					for (this.clear(); ++c < d; ) {
				...
				function nr(l) {
					var c = this.__data__;
					return Te ? c[l] !== void 0 : Kt.call(c, l);
				}
				function An(l, c) {
					var d = this.__data__;
					return (d[l] = Te && c === void 0 ? n : c), this;
				}
				...
				function Wr(l) {
					...
					if (d < 0) return !1;
					var E = c.length - 1;
					return d == E ? c.pop() : Hr.call(c, d, 1), !0;
				}
				function Zr(l) {
					var c = this.__data__,
						d = Ge(c, l);
				...
				(dt.prototype.clear = Vr),
					(dt.prototype.delete = Wr),
					(dt.prototype.get = Zr),
					(dt.prototype.has = Xr),
					(dt.prototype.set = Yr);
				function bt(l) {
				...
				(bt.prototype.clear = Qr),
					(bt.prototype.delete = Jr),
					(bt.prototype.get = ts),
					(bt.prototype.has = es),
					(bt.prototype.set = ns);
				function wt(l) {
				...
				function os(l, c) {
					...
					if (d instanceof dt) {
						var E = d.__data__;
						if (!we || E.length < e - 1) return E.push([l, c]), this;
						d = this.__data__ = new bt(E);
					}
					return d.set(l, c), this;
				}
				(wt.prototype.clear = rs),
					(wt.prototype.delete = ss),
					(wt.prototype.get = is),
					(wt.prototype.has = ls),
					(wt.prototype.set = os);
				function Ke(l, c) {
					var d = xn(l) || We(l) ? et(l.length, String) : [],
						E = d.length,
						H = !!E;
					for (var P in l)
						Kt.call(l, P) && !(H && (P == "length" || As(P, E))) && d.push(P);
					return d;
				}
				function rr(l, c, d) {
					var E = l[c];
					(!(Kt.call(l, c) && ar(E, d)) || (d === void 0 && !(c in l))) &&
						(l[c] = d);
				}
				function Ge(l, c) {
					for (var d = l.length; d--; ) if (ar(l[d][0], c)) return d;
					return -1;
				}
				function Gt(l, c) {
					return l && Tn(c, Sn(c), l);
				}
				function Nn(l, c, d, E, H, P, X) {
					var Z;
					if ((E && (Z = P ? E(l, H, P, X) : E(l)), Z !== void 0)) return Z;
					if (!Wt(l)) return l;
					var ut = xn(l);
					if (ut) {
						if (((Z = vs(l)), !c)) return ms(l, Z);
					} else {
						var tt = re(l),
							yt = tt == p || tt == v;
						if (cr(l)) return Ve(l, c);
						if (tt == y || tt == i || (yt && !P)) {
							if (ct(l)) return P ? l : {};
							if (((Z = Vt(yt ? {} : l)), !c)) return bs(l, Gt(Z, l));
						} else {
							if (!I[tt]) return P ? l : {};
							Z = Es(l, tt, Nn, c);
						}
					...
					var Tt = X.get(l);
					if (Tt) return Tt;
					if ((X.set(l, Z), !ut)) var ht = d ? ys(l) : Sn(l);
					return (
						Q(ht || l, (vt, gt) => {
							ht && ((gt = vt), (vt = l[gt])),
								rr(Z, gt, Nn(vt, c, d, E, gt, l, X));
						}),
						Z
					);
				}
				...
				function cs(l, c, d) {
					var E = c(l);
					return xn(l) ? E : Y(E, d(l));
				}
				function us(l) {
					return $e.call(l);
				}
				function hs(l) {
					if (!Wt(l) || ws(l)) return !1;
					var c = Ln(l) || ct(l) ? Fr : k;
					return c.test(Nt(l));
				}
				function fs(l) {
					if (!lr(l)) return tr(l);
				...
				function ds(l, c, d) {
					var E = c ? d(Zn(l), !0) : Zn(l);
					return J(E, G, new l.constructor());
				}
				function gs(l) {
					return er ? Object(er.call(l)) : {};
				}
				function ps(l, c) {
					var d = c ? wn(l.buffer) : l.buffer;
				...
				function Bt(l, c) {
					var d = nt(l, c);
					return hs(d) ? d : void 0;
				}
				var ne = pn ? fn(pn, Object) : xs,
					re = us;
				((He && re(new He(new ArrayBuffer(1))) != rt) ||
					(we && re(new we()) != f) ||
					(kt && re(kt.resolve()) != A) ||
					(ze && re(new ze()) != x) ||
					(mn && re(new mn()) != z)) &&
				...
				function Vt(l) {
					return typeof l.constructor == "function" && !lr(l) ? as(St(l)) : {};
				}
				function Es(l, c, d, E) {
					var H = l.constructor;
					switch (c) {
				...
				function lr(l) {
					var c = l && l.constructor,
						d = (typeof c == "function" && c.prototype) || Pe;
					return l === d;
				}
				function Nt(l) {
					if (l != null) {
				...
				function We(l) {
					return (
						Ts(l) &&
						Kt.call(l, "callee") &&
						(!Jn.call(l, "callee") || $e.call(l) == i)
					);
				}
				var xn = Array.isArray;
				function Ze(l) {
					return l != null && ur(l.length) && !Ln(l);
				}
				function Ts(l) {
					return hr(l) && Ze(l);
				}
			...
			((r, t) => {
				...
				($[b] = $[O] = $[S] = $[T] = $[_] = $[k] = $[j] = $[I] = $[K] = !0),
					($[a] =
						...
						$[xt] =
							!1);
				var it = typeof pe == "object" && pe && pe.Object === Object && pe,
					ot =
						typeof self == "object" && self && self.Object === Object && self,
					G = it || ot || Function("return this")(),
					Q = t && !t.nodeType && t,
					Y = Q && !0 && r && !r.nodeType && r,
					J = Y && Y.exports === Q,
					et = J && it.process,
					nt = (() => {
						try {
				...
				function mt(l, c) {
					for (
						var d = -1, E = l == null ? 0 : l.length, H = 0, P = [];
						++d < E;
					) {
						var X = l[d];
						c(X, d, l) && (P[H++] = X);
				...
				var $e = Array.prototype,
					...
					mn = pn ? pn.isBuffer : void 0,
					Te = Yn(Object.keys, Object),
					bn = ne(G, "DataView"),
					xe = ne(G, "Map"),
					yn = ne(G, "Promise"),
					vn = ne(G, "Set"),
					...
					Kr = Nt(vn),
					Gr = Nt(En),
					nr = Fe ? Fe.prototype : void 0,
					An = nr ? nr.valueOf : void 0;
				function dt(l) {
					var c = -1,
						d = l == null ? 0 : l.length;
					for (this.clear(); ++c < d; ) {
				...
				function Xr(l) {
					var c = this.__data__;
					return he ? c[l] !== void 0 : St.call(c, l);
				}
				function Yr(l, c) {
					var d = this.__data__;
					return (
				...
				function Jr(l) {
					...
					if (d < 0) return !1;
					var E = c.length - 1;
					return d == E ? c.pop() : we.call(c, d, 1), --this.size, !0;
				}
				function ts(l) {
					var c = this.__data__,
						d = Ve(c, l);
				...
				function Ke(l) {
					var c = -1,
						d = l == null ? 0 : l.length;
					for (this.__data__ = new wt(); ++c < d; ) this.add(l[c]);
				}
				function rr(l) {
				...
				(Ke.prototype.add = Ke.prototype.push = rr), (Ke.prototype.has = Ge);
				function Gt(l) {
				...
				function hs(l, c) {
					...
					if (d instanceof bt) {
						...
						d = this.__data__ = new wt(E);
					}
					return d.set(l, c), (this.size = d.size), this;
				}
				(Gt.prototype.clear = Nn),
					(Gt.prototype.delete = as),
					(Gt.prototype.get = cs),
					(Gt.prototype.has = us),
					(Gt.prototype.set = hs);
				function fs(l, c) {
				...
				function Ve(l, c) {
					for (var d = l.length; d--; ) if (or(l[d][0], c)) return d;
					return -1;
				}
				function wn(l, c, d) {
					var E = c(l);
				...
				function ir(l, c, d, E, H) {
					return l === c
						? !0
						: l == null || c == null || (!Wt(l) && !Wt(c))
							? l !== l && c !== c
							: ds(l, c, d, E, ir, H);
				}
				function ds(l, c, d, E, H, P) {
					var X = We(l),
						Z = We(c),
						ut = X ? u : Vt(l),
						tt = Z ? u : Vt(c);
					...
					if (ht && !yt)
						return (
							P || (P = new Gt()),
							X || hr(l) ? Tn(l, c, d, E, H, P) : bs(l, c, ut, d, E, H, P)
						);
					if (!(d & s)) {
						var vt = yt && St.call(l, "__wrapped__"),
							gt = Tt && St.call(c, "__wrapped__");
						if (vt || gt) {
							var fe = vt ? l.value() : l,
								se = gt ? c.value() : c;
							return P || (P = new Gt()), H(fe, se, d, E, P);
						}
					}
					return ht ? (P || (P = new Gt()), ys(l, c, d, E, H, P)) : !1;
				}
				function gs(l) {
					if (!ur(l) || Ns(l)) return !1;
					var c = cr(l) ? Hr : V;
					return c.test(Nt(l));
				}
				function ps(l) {
					return Wt(l) && Ln(l.length) && !!$[Le(l)];
				}
				function ms(l) {
					if (!ws(l)) return Te(l);
					var c = [];
				...
				function Tn(l, c, d, E, H, P) {
					var X = d & s,
						Z = l.length,
						ut = c.length;
					if (Z != ut && !(X && ut > Z)) return !1;
					var tt = P.get(l);
					if (tt && P.get(c)) return tt == c;
					var yt = -1,
						Tt = !0,
						ht = d & i ? new Ke() : void 0;
					for (P.set(l, c), P.set(c, l); ++yt < Z; ) {
						var vt = l[yt],
							gt = c[yt];
						if (E) var fe = X ? E(gt, vt, yt, c, l, P) : E(vt, gt, yt, l, c, P);
						if (fe !== void 0) {
							if (fe) continue;
							Tt = !1;
							break;
						...
						if (ht) {
							if (
								!Zn(c, (se, _e) => {
									if (!Pe(ht, _e) && (vt === se || H(vt, se, d, E, P)))
										return ht.push(_e);
								})
							) {
								Tt = !1;
						...
						} else if (!(vt === gt || H(vt, gt, d, E, P))) {
							Tt = !1;
							break;
						}
					}
					return P.delete(l), P.delete(c), Tt;
				}
				function bs(l, c, d, E, H, P, X) {
					switch (d) {
						case L:
						...
						case g:
							return !(
								l.byteLength != c.byteLength || !P(new tr(l), new tr(c))
							);
						case p:
						case v:
						case w:
						...
						case rt: {
							var ut = E & s;
							if ((Z || (Z = Kt), l.size != c.size && !ut)) return !1;
							var tt = X.get(l);
							if (tt) return tt == c;
							(E |= i), X.set(l, c);
							var yt = Tn(Z(l), Z(c), E, H, P, X);
							return X.delete(l), yt;
						}
						case ft:
							if (An) return An.call(l) == An.call(c);
					}
					return !1;
				}
				function ys(l, c, d, E, H, P) {
					var X = d & s,
						Z = Se(l),
						ut = Z.length,
						tt = Se(c),
					...
					for (var Tt = ut; Tt--; ) {
						var ht = Z[Tt];
						if (!(X ? ht in c : St.call(c, ht))) return !1;
					}
					var vt = P.get(l);
					if (vt && P.get(c)) return vt == c;
					var gt = !0;
					P.set(l, c), P.set(c, l);
					for (var fe = X; ++Tt < ut; ) {
						ht = Z[Tt];
						var se = l[ht],
							_e = c[ht];
						if (E) var Oi = X ? E(_e, se, ht, c, l, P) : E(se, _e, ht, l, c, P);
						if (!(Oi === void 0 ? se === _e || H(se, _e, d, E, P) : Oi)) {
							gt = !1;
							break;
						}
						fe || (fe = ht == "constructor");
					}
					if (gt && !fe) {
						var fr = l.constructor,
							dr = c.constructor;
						fr != dr &&
							"constructor" in l &&
							"constructor" in c &&
					...
					return P.delete(l), P.delete(c), gt;
				}
				function Se(l) {
					return wn(l, Sn, vs);
				}
				function Bt(l, c) {
					var d = l.__data__;
					return As(c) ? d[typeof c == "string" ? "string" : "hash"] : d.map;
				}
				function ne(l, c) {
					var d = dn(l, c);
					return gs(d) ? d : void 0;
				}
				function re(l) {
					var c = St.call(l, kt),
						d = l[kt];
				...
				var vs = ze
						? (l) =>
								l == null
									? []
									: ((l = Object(l)), mt(ze(l), (c) => He.call(l, c)))
						: xs,
					Vt = Le;
				((bn && Vt(new bn(new ArrayBuffer(1))) != L) ||
					(xe && Vt(new xe()) != A) ||
					(yn && Vt(yn.resolve()) != M) ||
					(vn && Vt(new vn()) != rt) ||
					(En && Vt(new En()) != xt)) &&
				...
				function ws(l) {
					var c = l && l.constructor,
						d = (typeof c == "function" && c.prototype) || Ne;
					return l === d;
				}
				function lr(l) {
					return Jn.call(l);
				...
				var ar = sr((() => arguments)())
						? sr
						: (l) => Wt(l) && St.call(l, "callee") && !He.call(l, "callee"),
					We = Array.isArray;
				function xn(l) {
					return l != null && Ln(l.length) && !cr(l);
				}
				var Ze = mn || Ls;
				function Ts(l, c) {
					return ir(l, c);
...
function _f() {
	if (ol) return mr;
	(ol = 1), Object.defineProperty(mr, "__esModule", { value: !0 });
	const r = fo(),
		t = go();
	var e;
	return (
		((n) => {
			function s(u = {}, h = {}, p = !1) {
				...
				let v = r(h);
				p ||
					(v = Object.keys(v).reduce(
						(f, m) => (v[m] != null && (f[m] = v[m]), f),
						{},
					));
				for (const f in u) u[f] !== void 0 && h[f] === void 0 && (v[f] = u[f]);
			...
			function i(u = {}, h = {}) {
				...
				const p = Object.keys(u)
					...
					.reduce(
						(v, f) => (
							t(u[f], h[f]) || (v[f] = h[f] === void 0 ? null : h[f]), v
						),
						{},
					);
			...
			function o(u = {}, h = {}) {
				u = u || {};
				const p = Object.keys(h).reduce(
					(v, f) => (h[f] !== u[f] && u[f] !== void 0 && (v[f] = h[f]), v),
					{},
				);
				return Object.keys(u).reduce(
					(v, f) => (u[f] !== h[f] && h[f] === void 0 && (v[f] = null), v),
					p,
				);
			}
			n.invert = o;
			function a(u, h, p = !1) {
				if (typeof u != "object") return h;
				if (typeof h != "object") return;
				if (!p) return h;
				const v = Object.keys(h).reduce(
					(f, m) => (u[m] === void 0 && (f[m] = h[m]), f),
					{},
				);
				return Object.keys(v).length > 0 ? v : void 0;
			}
...
function po() {
	if (al) return br;
	(al = 1), Object.defineProperty(br, "__esModule", { value: !0 });
	var r;
	return (
		((t) => {
			function e(n) {
...
function Of() {
	if (cl) return yr;
	(cl = 1), Object.defineProperty(yr, "__esModule", { value: !0 });
	const r = po();
	class t {
		constructor(n) {
		...
		next(n) {
			...
			if (s) {
				const i = this.offset,
					o = r.default.length(s);
				if (
					(n >= o - i
						? ((n = o - i), (this.index += 1), (this.offset = 0))
						: (this.offset += n),
				...
				const u = "\0",
					h = (v, f) => {
						...
						if (!m || m !== Object.keys(f)[0])
							throw new Error(
								`embed types not matched: ${m} != ${Object.keys(f)[0]}`,
							);
						return [m, v[m], f[m]];
					};
				class p {
					...
					static getHandler(f) {
						const m = p.handlers[f];
						if (!m) throw new Error(`no handlers for embed type "${f}"`);
						return m;
					}
					insert(f, m) {
						const y = {};
					...
					retain(f, m) {
						if (typeof f == "number" && f <= 0) return this;
						const y = { retain: f };
						return (
							m != null &&
								typeof m == "object" &&
					...
					slice(f = 0, m = 1 / 0) {
						const y = [],
							A = new a.default(this.ops);
						let w = 0;
						for (; w < m && A.hasNext(); ) {
							let x;
							w < f ? (x = A.next(f - w)) : ((x = A.next(m - w)), y.push(x)),
								(w += o.default.length(x));
						}
						return new p(y);
					}
					compose(f) {
						const m = new a.default(this.ops),
							y = new a.default(f.ops),
							A = [],
							w = y.peek();
						if (
							w != null &&
							...
							w.retain - C > 0 && y.next(w.retain - C);
						}
						const x = new p(A);
						for (; m.hasNext() || y.hasNext(); )
							if (y.peekType() === "insert") x.push(y.next());
							else if (m.peekType() === "delete") x.push(m.next());
							else {
								const C = Math.min(m.peekLength(), y.peekLength()),
									M = m.next(C),
									z = y.next(C);
								if (z.retain) {
									const U = {};
									if (typeof M.retain == "number")
										...
										const at = M.retain == null ? "insert" : "retain",
											[ft, Rt, xt] = h(M[at], z.retain),
											g = p.getHandler(ft);
										U[at] = { [ft]: g.compose(Rt, xt, at === "retain") };
									}
									const rt = i.default.compose(
										M.attributes,
										z.attributes,
									...
									if (
										(rt && (U.attributes = rt),
										x.push(U),
										!y.hasNext() && s(x.ops[x.ops.length - 1], U))
									) {
									...
									typeof z.delete == "number" &&
										(typeof M.retain == "number" ||
											(typeof M.retain == "object" && M.retain !== null)) &&
										x.push(z);
							}
						return x.chop();
					}
					concat(f) {
						...
						return (
							f.ops.length > 0 &&
								(m.push(f.ops[0]), (m.ops = m.ops.concat(f.ops.slice(1)))),
							m
						);
					}
					diff(f, m) {
						if (this.ops === f.ops) return new p();
						const y = [this, f].map((M) =>
								M.map((z) => {
									if (z.insert != null)
								...
								for (; z > 0; ) {
									...
									switch (M[0]) {
										...
										case e.EQUAL: {
											...
											const rt = x.next(U),
												at = C.next(U);
											s(rt.insert, at.insert)
												? A.retain(
														U,
														i.default.diff(rt.attributes, at.attributes),
													)
												: A.push(at).delete(U);
											break;
										}
...
`,
						...
						for (; y.hasNext(); ) {
							...
							const x = y.peek(),
								C = o.default.length(x) - y.peekLength(),
								M =
									typeof x.insert == "string" ? x.insert.indexOf(m, C) - C : -1;
							if (M < 0) A.push(y.next());
							else if (M > 0) A.push(y.next(M));
							else {
								if (f(A, y.next(1).attributes || {}, w) === !1) return;
								(w += 1), (A = new p());
							}
						}
						A.length() > 0 && f(A, {}, w);
											...
											f.slice(y, y + w).forEach((C) => {
												A.delete
													...
													: A.retain &&
														...
														m.retain(
															o.default.length(C),
															i.default.invert(A.attributes, C.attributes),
														);
											}),
											y + w
										);
									} else if (typeof A.retain == "object" && A.retain !== null) {
										const w = f.slice(y, y + 1),
											x = new a.default(w.ops).next(),
											[C, M, z] = h(A.retain, x.insert),
											U = p.getHandler(C);
										return (
											m.retain(
												{ [C]: U.invert(M, z) },
												i.default.invert(A.attributes, x.attributes),
											),
											y + 1
										);
									}
					...
					transform(f, m = !1) {
						...
						const y = f,
							A = new a.default(this.ops),
							w = new a.default(y.ops),
							x = new p();
						for (; A.hasNext() || w.hasNext(); )
							if (A.peekType() === "insert" && (m || w.peekType() !== "insert"))
								x.retain(o.default.length(A.next()));
							else if (w.peekType() === "insert") x.push(w.next());
							else {
								const C = Math.min(A.peekLength(), w.peekLength()),
									M = A.next(C),
									z = w.next(C);
								if (M.delete) continue;
								if (z.delete) x.push(z);
								else {
									const U = M.retain,
										rt = z.retain;
									...
									if (
										...
										if (ft === Object.keys(rt)[0]) {
											...
											Rt && (at = { [ft]: Rt.transform(U[ft], rt[ft], m) });
										}
									}
									x.retain(
										at,
										i.default.transform(M.attributes, z.attributes, m),
									);
								}
							}
						return x.chop();
					...
					transformPosition(f, m = !1) {
						...
						let A = 0;
						for (; y.hasNext() && A <= f; ) {
							const w = y.peekLength(),
								x = y.peekType();
							if ((y.next(), x === "delete")) {
								f -= Math.min(w, f - A);
								continue;
							} else x === "insert" && (A < f || !m) && (f += w);
							A += w;
						}
						return f;
					}
				...
				(p.Op = o.default),
					(p.OpIterator = a.default),
					(p.AttributeMap = i.default),
					(p.handlers = {}),
					(t.default = p),
					(r.exports = p),
					(r.exports.default = p);
...
function Mr(r) {
	return r.replace(/[&<>"']/g, (t) => Cf[t]);
}
const Zt = class Zt extends bi {
	static compare(t, e) {
		const n = Zt.order.indexOf(t),
			s = Zt.order.indexOf(e);
		return n >= 0 || s >= 0 ? n - s : t === e ? 0 : t < e ? -1 : 1;
	}
	formatAt(t, e, n, s) {
		if (
			Zt.compare(this.statics.blotName, n) < 0 &&
			this.scroll.query(n, D.BLOT)
		) {
			const i = this.isolate(t, e);
			s && i.wrap(n, s);
		} else super.formatAt(t, e, n, s);
	}
	optimize(t) {
		if (
			(super.optimize(t),
			this.parent instanceof Zt &&
				Zt.compare(this.statics.blotName, this.parent.statics.blotName) > 0)
		) {
...
q(Zt, "allowedChildren", [Zt, Ht, Lt, Ut]),
	q(Zt, "order", [
		"cursor",
		"inline",
		"link",
...
class pt extends $n {
	...
	delta() {
		return (
			this.cache.delta == null && (this.cache.delta = mo(this)),
			this.cache.delta
		);
	}
	deleteAt(e, n) {
	...
	formatAt(e, n, s, i) {
		n <= 0 ||
			(this.scroll.query(s, D.BLOCK)
				? e + n === this.length() && this.format(s, i)
				: super.formatAt(e, Math.min(n, this.length() - e - 1), s, i),
			(this.cache = {}));
	}
	insertAt(e, n, s) {
		if (s != null) {
...
`),
		...
		o.length > 0 &&
			(e < this.length() - 1 || this.children.tail == null
				? super.insertAt(Math.min(e, this.length() - 1), o)
				: this.children.tail.insertAt(this.children.tail.length(), o),
			(this.cache = {}));
		let a = this;
		i.reduce(
			(u, h) => ((a = a.split(u, !0)), a.insertAt(0, h), h.length),
			e + o.length,
		);
	}
	insertBefore(e, n) {
	...
	length() {
		return (
			this.cache.length == null && (this.cache.length = super.length() + hl),
			this.cache.length
		);
	}
	moveChildren(e, n) {
...
pt.tagName = "P";
pt.defaultChild = Ht;
pt.allowedChildren = [Ht, Jt, Lt, Ut];
class Ct extends Lt {
	attach() {
		super.attach(), (this.attributes = new kr(this.domNode));
	}
	delta() {
...
function mo(r) {
	...
	return r
		.descendants(Et)
		.reduce(
			(e, n) => (n.length() === 0 ? e : e.insert(n.value(), Ot(n, {}, t))),
			new B(),
		)
		.insert(
			`
...
function Ot(r) {
	...
	return r == null ||
		("formats" in r &&
			typeof r.formats == "function" &&
			((t = { ...t, ...r.formats() }), e && delete t["code-token"]),
		r.parent == null ||
			r.parent.statics.blotName === "scroll" ||
			r.parent.statics.scope !== r.statics.scope)
		? t
		: Ot(r.parent, t, e);
}
const _t = class _t extends Lt {
	...
	constructor(t, e, n) {
		super(t, e),
			(this.selection = n),
			(this.textNode = document.createTextNode(_t.CONTENTS)),
	...
	format(t, e) {
		...
		n != null &&
			((this.savedLength = _t.CONTENTS.length),
			n.optimize(),
			n.formatAt(s, _t.CONTENTS.length, t, e),
			(this.savedLength = 0));
	}
	index(t, e) {
	...
	restore() {
		...
		const e = this.prev instanceof Ut ? this.prev : null,
			n = e ? e.length() : 0,
			s = this.next instanceof Ut ? this.next : null,
			i = s ? s.text : "",
			{ textNode: o } = this,
			a = o.data.split(_t.CONTENTS).join("");
		o.data = _t.CONTENTS;
		let u;
		if (e)
			(u = e), (a || s) && (e.insertAt(e.length(), a + i), s && s.remove());
		else if (s) (u = s), s.insertAt(0, a);
		else {
					...
					e && f === e.domNode
						...
						: f === o
							...
							: s && f === s.domNode
								? n + a.length + m
								: null,
				p = h(t.start.node, t.start.offset),
				v = h(t.end.node, t.end.offset);
			if (p !== null && v !== null)
				return {
					startNode: u.domNode,
					startOffset: p,
	...
	update(t, e) {
		if (
			t.some((n) => n.type === "characterData" && n.target === this.textNode)
		) {
...
q(_t, "blotName", "cursor"),
	q(_t, "className", "ql-cursor"),
	q(_t, "tagName", "span"),
	q(_t, "CONTENTS", "\uFEFF");
const an = _t;
var Rs = { exports: {} },
	...
	return (
		fl ||
			...
			((r) => {
				...
				function n() {}
				Object.create &&
					((n.prototype = Object.create(null)), new n().__proto__ || (e = !1));
				function s(u, h, p) {
				...
				(a.prototype.eventNames = function () {
					...
					return Object.getOwnPropertySymbols
						? h.concat(Object.getOwnPropertySymbols(p))
						: h;
				}),
					...
					(a.prototype.emit = function (h, p, v, f, m, y) {
						...
						var w = this._events[A],
							x = arguments.length,
							C,
							M;
						if (w.fn) {
							switch ((w.once && this.removeListener(h, w.fn, void 0, !0), x)) {
								case 1:
									return w.fn.call(w.context), !0;
								case 2:
									return w.fn.call(w.context, p), !0;
								case 3:
									return w.fn.call(w.context, p, v), !0;
								case 4:
									return w.fn.call(w.context, p, v, f), !0;
								case 5:
									return w.fn.call(w.context, p, v, f, m), !0;
								case 6:
									return w.fn.call(w.context, p, v, f, m, y), !0;
							}
							...
							for (M = 0; M < z; M++)
								switch (
									(w[M].once && this.removeListener(h, w[M].fn, void 0, !0), x)
								) {
									case 1:
										w[M].fn.call(w[M].context);
										break;
									case 2:
										w[M].fn.call(w[M].context, p);
										break;
									case 3:
										w[M].fn.call(w[M].context, p, v);
										break;
									case 4:
										w[M].fn.call(w[M].context, p, v, f);
										break;
									default:
										if (!C)
											for (U = 1, C = new Array(x - 1); U < x; U++)
												C[U - 1] = arguments[U];
										w[M].fn.apply(w[M].context, C);
								}
						}
						return !0;
					}),
					...
					(a.prototype.removeListener = function (h, p, v, f) {
						...
						if (y.fn)
							...
							for (var A = 0, w = [], x = y.length; A < x; A++)
								(y[A].fn !== p ||
									(f && !y[A].once) ||
									(v && y[A].context !== v)) &&
									w.push(y[A]);
							w.length
								? (this._events[m] = w.length === 1 ? w[0] : w)
								: o(this, m);
						}
						return this;
					}),
					(a.prototype.removeAllListeners = function (h) {
						...
						return (
							h
								? ((p = e ? e + h : h), this._events[p] && o(this, p))
								: ((this._events = new n()), (this._eventsCount = 0)),
							this
						);
					}),
...
const kf = Bl(Rf),
	ti = new WeakMap(),
	ei = ["error", "warn", "log", "info"];
let ni = "warn";
function bo(r) {
	if (ni && ei.indexOf(r) <= ei.indexOf(ni)) {
		for (
...
function ue(r) {
	return ei.reduce((t, e) => ((t[e] = bo.bind(console, e, r)), t), {});
}
ue.level = (r) => {
	ni = r;
};
bo.level = ue.level;
const ks = ue("quill:events"),
	Bf = ["selectionchange", "mousedown", "mouseup", "click"];
Bf.forEach((r) => {
...
q(R, "events", {
	...
	q(R, "sources", { API: "api", SILENT: "silent", USER: "user" });
const Bs = ue("quill:selection");
class Ie {
	constructor(t) {
		const e =
...
class Mf {
	constructor(t, e) {
		(this.emitter = e),
			...
			this.emitter.listenDOM("selectionchange", document, () => {
				!this.mouseDown &&
					!this.composing &&
					setTimeout(this.update.bind(this, R.sources.USER), 1);
			}),
			this.emitter.on(R.events.SCROLL_BEFORE_UPDATE, () => {
				...
				n != null &&
					...
					this.emitter.once(R.events.SCROLL_UPDATE, (s, i) => {
						try {
							this.root.contains(n.start.node) &&
								this.root.contains(n.end.node) &&
								this.setNativeRange(
									n.start.node,
									n.start.offset,
									n.end.node,
	...
	format(t, e) {
		...
		if (!(n == null || !n.native.collapsed || this.scroll.query(t, D.BLOCK))) {
			if (n.start.node !== this.cursor.textNode) {
				...
				} else s.insertBefore(this.cursor, n.start.node);
				this.cursor.attach();
			}
	...
	getBounds(t) {
		...
		if (e > 0 && o === i.length()) {
			...
			if (p) {
				const [v] = this.scroll.line(t),
					[f] = this.scroll.line(t + 1);
				v === f && ((i = p), (o = 0));
			}
		}
		[s, o] = i.position(o, !0);
		...
		if (s instanceof Text) {
			...
			o < s.data.length
				? (a.setStart(s, o), a.setEnd(s, o + 1))
				: (a.setStart(s, o - 1), a.setEnd(s, o), (u = "right")),
	...
	getNativeRange() {
		...
		return Bs.info("getNativeRange", n), n;
	}
	getRange() {
	...
	hasFocus() {
		return (
			...
			(document.activeElement != null && Ms(this.root, document.activeElement))
		);
	}
	normalizedToRange(t) {
		...
		const n = e.map((o) => {
				const [a, u] = o,
					h = this.scroll.find(a, !0),
					p = h.offset(this.scroll);
				return u === 0
					? p
					: h instanceof Et
						? p + h.index(a, u)
			...
			s = Math.min(Math.max(...n), this.scroll.length() - 1),
			i = Math.min(s, ...n);
		return new Ie(i, s - i);
	}
	normalizeNative(t) {
		if (
			!Ms(this.root, t.startContainer) ||
			(!t.collapsed && !Ms(this.root, t.endContainer))
		)
			return null;
		const e = {
	...
	setNativeRange(t, e) {
		let n = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : t,
			s = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : e,
			i = arguments.length > 4 && arguments[4] !== void 0 ? arguments[4] : !1;
		if (
			(Bs.info("setNativeRange", t, e, n, s),
			t != null &&
				...
				if (
					...
					t instanceof Element &&
						...
						n instanceof Element &&
							n.tagName === "BR" &&
							((s = Array.from(n.parentNode.childNodes).indexOf(n)),
							(n = n.parentNode));
	...
	update() {
		...
		if (
			...
			this.emitter.emit(R.events.EDITOR_CHANGE, ...i),
				t !== R.sources.SILENT && this.emitter.emit(...i);
		}
	}
}
function Ms(r, t) {
				...
				if (a.insert != null) {
					if ((s.retain(u), typeof a.insert == "string")) {
						...
						(v =
							!y.endsWith(`
`) &&
							(e <= o || !!this.scroll.descendant(Ct, o)[0])),
							this.scroll.insertAt(o, y);
						const [A, w] = this.scroll.line(o);
						let x = ye({}, Ot(A));
						if (A instanceof pt) {
							const [C] = A.descendant(Et, w);
							C && (x = ye(x, Ot(C)));
						}
						...
						if (A) (e <= o || this.scroll.descendant(Ct, o)[0]) && (v = !0);
						else if (o > 0) {
							const [w, x] = this.scroll.descendant(Et, o - 1);
							w instanceof Ut
								? w.value()[x] !==
										`
` && (p = !0)
								: w instanceof Lt &&
									w.statics.scope === D.INLINE_BLOT &&
									(p = !0);
						}
						if ((this.scroll.insertAt(o, y, a.insert[y]), A)) {
							const [w] = this.scroll.descendant(Et, o);
							if (w) {
								const x = ye({}, Ot(w));
								h = It.AttributeMap.diff(x, h) || {};
							}
					...
					(s.push(a), a.retain !== null && typeof a.retain == "object")
				) {
	...
	getFormat(t) {
		...
		e === 0
			...
			: ((n = this.scroll.lines(t, e)),
				(s = this.scroll.descendants(Et, t, e)));
		const [i, o] = [n, s].map((a) => {
			const u = a.shift();
			if (u == null) return {};
			let h = Ot(u);
	...
	getHTML(t, e) {
		...
		if (n) {
			const i = n.length();
			return n.length() >= s + e && !(s === 0 && e === i)
				? Un(n, s, e, !0)
				: Un(this.scroll, t, e, !0);
		}
		return "";
	}
	getText(t, e) {
		return this.getContents(t, e)
			.filter((n) => typeof n.insert == "string")
			.map((n) => n.insert)
			.join("");
	}
	insertContents(t, e) {
		const n = dl(e),
			s = new B().retain(t).concat(n);
		return this.scroll.insertContents(t, n), this.update(s);
	}
	insertEmbed(t, e, n) {
		return (
			this.scroll.insertAt(t, e, n),
			this.update(new B().retain(t).insert({ [e]: n }))
		);
	}
	insertText(t, e) {
		const n =
	...
	removeFormat(t, e) {
		...
		s != null &&
			...
			(a = s
				...
				.insert(`
`)));
		const h = this.getContents(t, e + o).diff(new B().insert(n).concat(a)),
			p = new B().retain(t).concat(h);
	...
	update(t) {
		...
		if (
			e.length === 1 &&
			e[0].type === "characterData" &&
			e[0].target.data.match(Df) &&
			this.scroll.find(e[0].target)
		) {
			const i = this.scroll.find(e[0].target),
				o = Ot(i),
				a = i.offset(this.scroll),
				u = e[0].oldValue.replace(an.CONTENTS, ""),
				h = new B().insert(u),
				p = new B().insert(i.value()),
				v = n && { oldRange: gl(n.oldRange, -a), newRange: gl(n.newRange, -a) };
			(t = new B()
				.retain(a)
				.concat(h.diff(p, v))
				.reduce(
					(m, y) => (y.insert ? m.insert(y.insert, o) : m.push(y)),
					new B(),
				)),
				(this.delta = s.compose(t));
		} else
			(this.delta = this.getDelta()),
				(!t || !ge(s.compose(t), this.delta)) && (t = s.diff(this.delta, n));
		return t;
	}
}
function tn(r, t, e) {
	...
	const [{ child: n, offset: s, length: i, indent: o, type: a }, ...u] = r,
		[h, p] = Ds(a);
	if (o > t)
		return (
			e.push(a),
			o === t + 1
				? `<${h}><li${p}>${Un(n, s, i)}${tn(u, o, e)}`
				: `<${h}><li>${tn(r, t + 1, e)}`
		);
	const v = e[e.length - 1];
	if (o === t && a === v) return `</li><li${p}>${Un(n, s, i)}${tn(u, o, e)}`;
	const [f] = Ds(e.pop());
	return `</li></${f}>${tn(r, t - 1, e)}`;
}
function Un(r, t, e) {
	const n = arguments.length > 3 && arguments[3] !== void 0 ? arguments[3] : !1;
	if ("html" in r && typeof r.html == "function") return r.html(t, e);
	if (r instanceof Ut)
		return Mr(r.value().slice(t, t + e)).replaceAll(" ", "&nbsp;");
	if (r instanceof $t) {
		if (r.statics.blotName === "list-container") {
			const h = [];
			return (
				r.children.forEachAt(t, e, (p, v, f) => {
					const m =
						"formats" in p && typeof p.formats == "function" ? p.formats() : {};
					h.push({
						child: p,
						offset: v,
						length: f,
		...
		const s = [];
		if (
			(r.children.forEachAt(t, e, (h, p, v) => {
				s.push(Un(h, p, v));
			}),
			n || r.statics.blotName === "list")
		)
			return s.join("");
		const { outerHTML: i, innerHTML: o } = r.domNode,
			[a, u] = i.split(`>${o}<`);
		return a === "<table"
			? `<table style="border: 1px solid #000;">${s.join("")}<${u}`
			: `${a}>${s.join("")}<${u}`;
	}
...
`,
								...
								s && t.push({ insert: s, attributes: e.attributes });
						})
				: t.push(e);
		}),
		t
...
class vi extends Lt {
	constructor(t, e) {
		super(t, e),
			...
			(this.leftGuard = document.createTextNode(vr)),
			(this.rightGuard = document.createTextNode(vr)),
	...
	restore(t) {
		let e = null,
			n;
		const s = t.data.split(vr).join("");
		if (t === this.leftGuard)
			if (this.prev instanceof Ut) {
				const i = this.prev.length();
				this.prev.insertAt(i, s),
					(e = { startNode: this.prev.domNode, startOffset: i + s.length });
			} else
				(n = document.createTextNode(s)),
					this.parent.insertBefore(this.scroll.create(n), this),
					(e = { startNode: n, startOffset: s.length });
		else
			t === this.rightGuard &&
				(this.next instanceof Ut
					? (this.next.insertAt(0, s),
						(e = { startNode: this.next.domNode, startOffset: s.length }))
					: ((n = document.createTextNode(s)),
	...
	update(t, e) {
		t.forEach((n) => {
			if (
				...
				(n.target === this.leftGuard || n.target === this.rightGuard)
			) {
...
class Uf {
	...
	handleCompositionStart(t) {
		...
		e &&
			!(e instanceof vi) &&
			(this.emitter.emit(R.events.COMPOSITION_BEFORE_START, t),
			this.scroll.batchStart(),
...
q(Bn, "DEFAULTS", { modules: {} }), q(Bn, "themes", { default: Bn });
const cn = Bn;
const Ff = (r) => r.parentElement || r.getRootNode().host || null,
	Hf = (r) => {
		const t = r.getBoundingClientRect(),
			e = ("offsetWidth" in r && Math.abs(t.width) / r.offsetWidth) || 1,
			n = ("offsetHeight" in r && Math.abs(t.height) / r.offsetHeight) || 1;
		return {
			top: t.top,
		...
		for (; s; ) {
			const u = s === e.body,
				h = u
					...
					: Hf(s),
				p = getComputedStyle(s),
				v = pl(
					n.left,
					n.right,
					h.left,
					h.right,
					Er(p.scrollPaddingLeft),
					Er(p.scrollPaddingRight),
				),
				f = pl(
					n.top,
					n.bottom,
					h.top,
					h.bottom,
					Er(p.scrollPaddingTop),
					Er(p.scrollPaddingBottom),
				);
			if (v || f)
				if (u) (a = e.defaultView) == null || a.scrollBy(v, f);
				else {
					const { scrollLeft: m, scrollTop: y } = s;
					f && (s.scrollTop += f), v && (s.scrollLeft += v);
					const A = s.scrollLeft - m,
						w = s.scrollTop - y;
					n = {
						left: n.left - A,
						top: n.top - w,
			...
			s = u || p.position === "fixed" ? null : Ff(s);
		}
	},
	Kf = 100,
	Gf = ["block", "break", "cursor", "inline", "scroll", "text"],
	Vf = (r, t, e) => {
		const n = new on();
		return (
			Gf.forEach((s) => {
...
const Dt = class Dt {
	...
	static find(t) {
		const e =
			arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1;
		return ti.get(t) || Ar.find(t, e);
	}
	static import(t) {
		return (
			Dt.imports[t] == null &&
				sn.error(`Cannot import ${t}. Are you sure it was registered?`),
			Dt.imports[t]
		);
	}
	static register() {
		if (typeof (arguments.length <= 0 ? void 0 : arguments[0]) != "string") {
			...
			Dt.imports[t] != null && !n && sn.warn(`Overwriting ${t} with`, e),
				(Dt.imports[t] = e),
				(t.startsWith("blots/") || t.startsWith("formats/")) &&
					...
					e.blotName !== "abstract" &&
					Ar.register(e),
				typeof e.register == "function" && e.register(Ar);
		}
	}
	constructor(t) {
		const e =
		...
		if (
			...
			(this.editor = new jf(this.scroll)),
			(this.selection = new Mf(this.scroll, this.emitter)),
			(this.composition = new Uf(this.scroll, this.emitter)),
			...
			this.theme.init(),
			this.emitter.on(R.events.EDITOR_CHANGE, (o) => {
				o === R.events.TEXT_CHANGE &&
					this.root.classList.toggle("ql-blank", this.editor.isBlank());
			}),
			this.emitter.on(R.events.SCROLL_UPDATE, (o, a) => {
				const u = this.selection.lastRange,
					[h] = this.selection.getRange(),
					p = u && h ? { oldRange: u, newRange: h } : void 0;
...
`,
	...
	deleteText(t, e, n) {
		return (
			([t, e, , n] = ie(t, e, n)),
			Mt.call(this, () => this.editor.deleteText(t, e), n, t, -1 * e)
		);
	}
	disable() {
		this.enable(!1);
		...
		return Mt.call(
			...
			() => {
				...
				if (this.scroll.query(t, D.BLOCK))
					...
					if (s.length === 0) return this.selection.format(t, e), i;
	...
	getBounds(t) {
		...
		if (
			(typeof t == "number"
				? (n = this.selection.getBounds(t, e))
				: (n = this.selection.getBounds(t.index, t.length)),
			!n)
		)
			return null;
	...
	getSemanticHTML() {
		...
		return (
			typeof t == "number" && (e = e ?? this.getLength() - t),
			([t, e] = ie(t, e)),
	...
	insertText(t, e, n, s, i) {
		...
		return (
			([t, , o, i] = ie(t, 0, n, s, i)),
			Mt.call(this, () => this.editor.insertText(t, e, o), i, t, e.length)
		);
	}
	isEnabled() {
	...
	removeFormat(t, e, n) {
		return (
			([t, e, , n] = ie(t, e, n)),
			Mt.call(this, () => this.editor.removeFormat(t, e), n, t)
		);
	}
	...
	setSelection(t, e, n) {
		t == null
			? this.selection.setRange(null, e || Dt.sources.API)
			: (([t, e, , n] = ie(t, e, n)),
				this.selection.setRange(new Ie(Math.max(0, t), e), n),
	...
	updateContents(t) {
		...
		return Mt.call(
			this,
			() => ((t = new B(t)), this.editor.applyDelta(t)),
			e,
			!0,
		);
	}
...
q(Dt, "DEFAULTS", {
	...
	q(Dt, "events", R.events),
	q(Dt, "sources", R.sources),
	q(Dt, "version", "2.0.3"),
	q(Dt, "imports", {
		delta: B,
		parchment: Lf,
...
function Wf(r, t) {
	...
	const s =
		!t.theme || t.theme === N.DEFAULTS.theme
			? cn
			: N.import(`themes/${t.theme}`);
	if (!s) throw new Error(`Invalid theme ${t.theme}. Did you register it?`);
	const { modules: i, ...o } = N.DEFAULTS,
		{ modules: a, ...u } = s.DEFAULTS;
	let h = js(t.modules);
	h != null &&
		h.toolbar &&
		h.toolbar.constructor !== Object &&
		(h = { ...h, toolbar: { container: h.toolbar } });
	const p = ye({}, js(i), js(a), h),
		v = { ...o, ...bl(u), ...bl(t) };
	let f = t.registry;
	return (
		f
			? t.formats &&
				sn.warn('Ignoring "formats" option because "registry" is specified')
			: (f = t.formats ? Vf(t.formats, v.registry, sn) : v.registry),
		{
			...v,
			registry: f,
			container: e,
			...
			modules: Object.entries(p).reduce((m, y) => {
				const [A, w] = y;
				if (!w) return m;
				const x = N.import(`modules/${A}`);
				return x == null
					? (sn.error(
							`Cannot load ${A} module. Are you sure you registered it?`,
						),
						m)
					: { ...m, [A]: ye({}, x.DEFAULTS || {}, w) };
			}, {}),
...
function Mt(r, t, e, n) {
	...
	if (
		(s != null &&
			(e === !0 && (e = s.index),
			n == null ? (s = yl(s, o, t)) : n !== 0 && (s = yl(s, e, n, t)),
			this.setSelection(s, R.sources.SILENT)),
		o.length() > 0)
	) {
		const a = [R.events.TEXT_CHANGE, o, i, t];
		this.emitter.emit(R.events.EDITOR_CHANGE, ...a),
			t !== R.sources.SILENT && this.emitter.emit(...a);
	}
	return o;
}
function ie(r, t, e, n, s) {
	let i = {};
	return (
		typeof r.index == "number" && typeof r.length == "number"
			? typeof t != "number"
				? ((s = n), (n = e), (e = t), (t = r.length), (r = r.index))
				: ((t = r.length), (r = r.index))
			: typeof t != "number" && ((s = n), (n = e), (e = t), (t = 0)),
		typeof e == "object"
			? ((i = e), (s = n))
			: typeof e == "string" && (n != null ? (i[e] = n) : (s = e)),
		(s = s || R.sources.API),
		[r, t, i, s]
	);
}
function yl(r, t, e, n) {
	...
	return (
		t && typeof t.transformPosition == "function"
			? ([i, o] = [r.index, r.index + r.length].map((a) =>
					t.transformPosition(a, n !== R.sources.USER),
				))
			: ([i, o] = [r.index, r.index + r.length].map((a) =>
					a < t || (a === t && n === R.sources.USER)
						? a
						: s >= 0
							? a + s
							: Math.max(t, a + s),
...
`),
		...
		if (i) {
			const u =
					i.type === "block" &&
					(i.delta.length() === 0 ||
						(!this.descendant(Ct, t)[0] && t < this.length())),
				h = i.type === "block" ? i.delta : new B().insert({ [i.key]: i.value });
			Ps(this, t, h);
			const p = i.type === "block" ? 1 : 0,
				v = t + h.length() + p;
			u &&
				this.insertAt(
					v - 1,
...
`,
			...
			const f = Ot(this.line(t)[0]),
				m = It.AttributeMap.diff(f, i.attributes) || {};
			...
			(n.length &&
				...
				n.forEach((u) => {
					if (u.type === "block") {
						...
						this.insertBefore(h, o || void 0),
							Object.keys(u.attributes).forEach((p) => {
	...
	line(t) {
		return t === this.length() ? this.line(t - 1) : this.descendant(vl, t);
	}
	lines() {
		const t =
				arguments.length > 0 && arguments[0] !== void 0 ? arguments[0] : 0,
		...
		const n = (s, i, o) => {
			let a = [],
				u = o;
			return (
				s.children.forEachAt(i, o, (h, p, v) => {
					vl(h) ? a.push(h) : h instanceof Br && (a = a.concat(n(h, p, u))),
						(u -= v);
				}),
				a
			);
	...
	updateEmbedAt(t, e, n) {
		...
		s && s.statics.blotName === e && El(s) && s.updateContent(n);
	}
	handleDragStart(t) {
		t.preventDefault();
	}
...
q(en, "blotName", "scroll"),
	q(en, "className", "ql-editor"),
	q(en, "tagName", "DIV"),
	q(en, "defaultChild", pt),
	q(en, "allowedChildren", [pt, Ct, Me]);
function Ps(r, t, e) {
	e.reduce((n, s) => {
		...
		if (s.insert != null) {
			if (typeof s.insert == "string") {
				...
				if (a == null) return n;
				if (
					(r.insertAt(n, a, s.insert[a]), r.scroll.query(a, D.INLINE) != null)
				) {
					const [h] = r.descendant(Et, n),
						p = Ot(h);
...
const Ei = { scope: D.BLOCK, whitelist: ["right", "center", "justify"] },
	Zf = new Qt("align", "align", Ei),
	yo = new Ft("align", "ql-align", Ei),
	vo = new Ae("align", "text-align", Ei);
class Eo extends Ae {
	value(t) {
		let e = super.value(t);
...
const Xf = new Ft("color", "ql-color", { scope: D.INLINE }),
	Ai = new Eo("color", "color", { scope: D.INLINE }),
	Yf = new Ft("background", "ql-bg", { scope: D.INLINE }),
	Ni = new Eo("background", "background-color", { scope: D.INLINE });
class De extends Me {
	static create(t) {
		const e = Me.create(t);
	...
	code(t, e) {
		return this.children
			.map((n) => (n.length() <= 1 ? "" : n.domNode.innerText))
			.join(`
`)
			.slice(t, t + e);
	}
...
const Ti = { scope: D.BLOCK, whitelist: ["rtl"] },
	Ao = new Qt("direction", "dir", Ti),
	No = new Ft("direction", "ql-direction", Ti),
	wo = new Ae("direction", "direction", Ti),
	To = { scope: D.INLINE, whitelist: ["serif", "monospace"] },
	xo = new Ft("font", "ql-font", To);
class Qf extends Ae {
	value(t) {
		return super.value(t).replace(/["']/g, "");
	}
}
const Lo = new Qf("font", "font-family", To),
	So = new Ft("size", "ql-size", {
		scope: D.INLINE,
		whitelist: ["small", "large", "huge"],
	}),
	_o = new Ae("size", "font-size", {
		scope: D.INLINE,
		whitelist: ["10px", "18px", "32px"],
	}),
	Jf = ue("quill:keyboard"),
	td = /Mac/i.test(navigator.platform) ? "metaKey" : "ctrlKey";
class Dr extends zt {
	static match(t, e) {
	...
	listen() {
		this.quill.root.addEventListener("keydown", (t) => {
			...
			const s = (this.bindings[t.key] || [])
				...
				.filter((x) => Dr.match(t, x));
			if (s.length === 0) return;
			const i = N.find(t.target, !0);
			if (i && i.scroll !== this.quill.scroll) return;
			const o = this.quill.getSelection();
			if (o == null || !this.quill.hasFocus()) return;
			const [a, u] = this.quill.getLine(o.index),
				[h, p] = this.quill.getLeaf(o.index),
				[v, f] =
					o.length === 0 ? [h, p] : this.quill.getLeaf(o.index + o.length),
				m = h instanceof qr ? h.value().slice(0, p) : "",
				y = v instanceof qr ? v.value().slice(f) : "",
				A = {
			...
			s.some((x) => {
				if (
					(x.collapsed != null && x.collapsed !== A.collapsed) ||
					(x.empty != null && x.empty !== A.empty) ||
					(x.offset != null && x.offset !== A.offset)
				)
					return !1;
				if (Array.isArray(x.format)) {
					if (x.format.every((C) => A.format[C] == null)) return !1;
				} else if (
					typeof x.format == "object" &&
					!Object.keys(x.format).every((C) =>
						x.format[C] === !0
							? A.format[C] != null
							: x.format[C] === !1
								? A.format[C] == null
								: ge(x.format[C], A.format[C]),
					)
				)
					return !1;
				return (x.prefix != null && !x.prefix.test(A.prefix)) ||
					(x.suffix != null && !x.suffix.test(A.suffix))
					? !1
					: x.handler.call(this, o, A, x) !== !0;
			}) && t.preventDefault();
		});
	}
	handleBackspace(t, e) {
		...
		if (e.offset === 0) {
			...
			if (a && !(a.statics.blotName === "block" && a.length() <= 1)) {
				const h = i.formats(),
					p = this.quill.getFormat(t.index - 1, 1);
				if (
					((s = It.AttributeMap.diff(h, p) || {}), Object.keys(s).length > 0)
				) {
	...
	handleDelete(t, e) {
		...
		if (e.offset >= i.length() - 1) {
			...
			if (a) {
				...
				(s = It.AttributeMap.diff(u, h) || {}),
					Object.keys(s).length > 0 &&
						(o = o.retain(a.length() - 1).retain(1, s));
			}
		}
		this.quill.updateContents(o, N.sources.USER), this.quill.focus();
	}
	handleDeleteRange(t) {
		xi({ range: t, quill: this.quill }), this.quill.focus();
	}
	handleEnter(t, e) {
		const n = Object.keys(e.format).reduce(
				(i, o) => (
					this.quill.scroll.query(o, D.BLOCK) &&
						!Array.isArray(e.format[o]) &&
						(i[o] = e.format[o]),
					i
				),
				{},
...
`,
		...
		this.quill.updateContents(s, N.sources.USER),
			this.quill.setSelection(t.index + 1, N.sources.SILENT),
			this.quill.focus();
	}
}
const ed = {
	bindings: {
		...
		indent: {
			...
			handler(r, t) {
				return t.collapsed && t.offset !== 0
					? !0
					: (this.quill.format("indent", "+1", N.sources.USER), !1);
			},
		},
		outdent: {
			key: "Tab",
		...
		"outdent backspace": {
			...
			handler(r, t) {
				t.format.indent != null
					? this.quill.format("indent", "-1", N.sources.USER)
					: t.format.list != null &&
						this.quill.format("list", !1, N.sources.USER);
			},
		},
		...
		tab: {
			...
			handler(r, t) {
				...
				return (
					this.quill.updateContents(e, N.sources.USER),
					this.quill.history.cutoff(),
					this.quill.setSelection(r.index + 1, N.sources.SILENT),
					!1
				);
			},
		},
		...
		"list empty enter": {
			...
			handler(r, t) {
				...
				t.format.indent && (e.indent = !1),
					this.quill.formatLine(r.index, r.length, e, N.sources.USER);
			},
		},
		"checklist enter": {
			key: "Enter",
...
`,
		...
		"header enter": {
			...
			suffix: /^$/,
			handler(r, t) {
				const [e, n] = this.quill.getLine(r.index),
					s = new B()
						.retain(r.index)
						.insert(
							`
...
`);
						this.quill.updateContents(u, N.sources.USER),
							this.quill.setSelection(r.index + 1, r.length, N.sources.SILENT);
					} else if (o > 0) {
						a += e.length();
						const u = new B().retain(a).insert(`
`);
						this.quill.updateContents(u, N.sources.USER),
							this.quill.setSelection(a, N.sources.USER);
					}
				}
			},
		},
		"table tab": {
			...
			handler(r, t) {
				const { event: e, line: n } = t,
					s = n.offset(this.quill.scroll);
				e.shiftKey
					? this.quill.setSelection(s - 1, N.sources.USER)
					: this.quill.setSelection(s + n.length(), N.sources.USER);
			},
		},
		"list autofill": {
			key: " ",
			...
			handler(r, t) {
				...
				const { length: e } = t.prefix,
					[n, s] = this.quill.getLine(r.index);
				if (s > e) return !0;
				let i;
				...
				this.quill.insertText(r.index, " ", N.sources.USER),
					this.quill.history.cutoff();
				const o = new B()
					.retain(r.index - s)
					.delete(e + 1)
					...
					.retain(1, { list: i });
				return (
					this.quill.updateContents(o, N.sources.USER),
					this.quill.history.cutoff(),
					this.quill.setSelection(r.index - e, N.sources.SILENT),
					!1
				);
			},
		},
		"code exit": {
			...
			handler(r) {
				...
				for (; s != null && s.length() <= 1 && s.formats()["code-block"]; )
					if (((s = s.prev), (n -= 1), n <= 0)) {
						const i = new B()
							.retain(r.index + t.length() - e - 2)
							.retain(1, { "code-block": null })
							.delete(1);
						return (
							this.quill.updateContents(i, N.sources.USER),
							this.quill.setSelection(r.index - 1, N.sources.SILENT),
							!1
						);
					}
	...
	return {
		...
		handler(t, e) {
			...
			if (t.length === 0 && !n.shiftKey) {
				this.quill.insertText(t.index, i, N.sources.USER),
					this.quill.setSelection(t.index + i.length, N.sources.SILENT);
				return;
			}
			const o =
				t.length === 0
			...
			let { index: a, length: u } = t;
			o.forEach((h, p) => {
				r
					? (h.insertAt(0, i), p === 0 ? (a += i.length) : (u += i.length))
					: h.domNode.textContent.startsWith(i) &&
						(h.deleteAt(0, i.length),
						p === 0 ? (a -= i.length) : (u -= i.length));
			}),
				this.quill.update(N.sources.USER),
				this.quill.setSelection(a, u, N.sources.SILENT);
		},
	};
}
function Nr(r, t) {
			...
			return i instanceof Lt
				? (r === "ArrowLeft"
						? t
							...
							: this.quill.setSelection(n.index - 1, N.sources.USER)
						: t
							? this.quill.setSelection(n.index, n.length + 1, N.sources.USER)
							: this.quill.setSelection(n.index + n.length + 1, N.sources.USER),
					!1)
				: !0;
		},
		...
		handler(t, e) {
			...
			if (i != null) {
				if (i.statics.blotName === "table-row") {
					...
					const u =
						o.offset(this.quill.scroll) + Math.min(e.offset, o.length() - 1);
...
function nd(r) {
	if (typeof r == "string" || typeof r == "number") r = { key: r };
	else if (typeof r == "object") r = nn(r);
	else return null;
	return r.shortKey && ((r[td] = r.shortKey), delete r.shortKey), r;
}
function xi(r) {
	const { quill: t, range: e } = r;
	const n = t.getLines(e);
	let s = {};
	if (n.length > 1) {
		const i = n[0].formats(),
			o = n[n.length - 1].formats();
		s = It.AttributeMap.diff(o, i) || {};
	}
	t.deleteText(e, N.sources.USER),
		Object.keys(s).length > 0 && t.formatLine(e.index, 1, s, N.sources.USER),
		t.setSelection(e.index, N.sources.SILENT);
}
function rd(r, t, e, n) {
...
const sd = /font-weight:\s*normal/,
	id = ["P", "OL", "UL"],
	wl = (r) => r && id.includes(r.tagName),
	ld = (r) => {
		Array.from(r.querySelectorAll("br"))
			.filter((t) => wl(t.previousElementSibling) && wl(t.nextElementSibling))
			.forEach((t) => {
				var e;
	...
	od = (r) => {
		Array.from(r.querySelectorAll('b[style*="font-weight"]'))
			.filter((t) => {
				var e;
...
function ad(r) {
	r.querySelector('[id^="docs-internal-guid-"]') && (od(r), ld(r));
}
const cd = /\bmso-list:[^;]*ignore/i,
	ud = /\bmso-list:[^;]*\bl(\d+)/i,
	hd = /\bmso-list:[^;]*\blevel(\d+)/i,
	fd = (r, t) => {
		const e = r.getAttribute("style"),
			n = e == null ? void 0 : e.match(ud);
		if (!n) return null;
		const s = Number(n[1]),
			i = e == null ? void 0 : e.match(hd),
			o = i ? Number(i[1]) : 1,
			a = new RegExp(
			...
			u = t.match(a),
			h = u && u[1] === "bullet" ? "bullet" : "ordered";
		return { id: s, indent: o, type: h, element: r };
	},
	dd = (r) => {
		var o, a;
		const t = Array.from(r.querySelectorAll("[style*=mso-list]")),
			e = [],
			n = [];
		t.forEach((u) => {
			(u.getAttribute("style") || "").match(cd) ? e.push(u) : n.push(u);
		}),
			e.forEach((u) => {
				var h;
				return (h = u.parentNode) == null ? void 0 : h.removeChild(u);
			});
		const s = r.documentElement.innerHTML,
			i = n.map((u) => fd(u, s)).filter((u) => u);
		for (; i.length; ) {
			const u = [];
			let h = i.shift();
			for (; h; )
			...
			u.forEach((m) => {
				...
				y.setAttribute("data-list", m.type),
					m.indent > 1 && y.setAttribute("class", `ql-indent-${m.indent - 1}`),
					(y.innerHTML = m.element.innerHTML),
					p.appendChild(y);
			});
			const v = (a = u[0]) == null ? void 0 : a.element,
				{ parentNode: f } = v ?? {};
			v && (f == null || f.replaceChild(p, v)),
				u.slice(1).forEach((m) => {
					const { element: y } = m;
...
function gd(r) {
	r.documentElement.getAttribute("xmlns:w") ===
		"urn:schemas-microsoft-com:office:word" && dd(r);
}
const pd = [gd, ad],
	md = (r) => {
		r.documentElement &&
	...
	bd = ue("quill:clipboard"),
	yd = [
		[Node.TEXT_NODE, qd],
		[Node.TEXT_NODE, xl],
		["br", wd],
		[Node.ELEMENT_NODE, xl],
		[Node.ELEMENT_NODE, Nd],
		[Node.ELEMENT_NODE, Ad],
		[Node.ELEMENT_NODE, _d],
		["li", Ld],
		["ol, ul", Sd],
		["pre", Td],
		["tr", Od],
	...
	vd = [Zf, Ao].reduce((r, t) => ((r[t.keyName] = t), r), {}),
	Tl = [vo, Ni, Ai, wo, Lo, _o].reduce((r, t) => ((r[t.keyName] = t), r), {});
class Oo extends zt {
	constructor(t, e) {
		super(t, e),
			this.quill.root.addEventListener("copy", (n) =>
				this.onCaptureCopy(n, !1),
			),
			this.quill.root.addEventListener("cut", (n) => this.onCaptureCopy(n, !0)),
			this.quill.root.addEventListener("paste", this.onCapturePaste.bind(this)),
			(this.matchers = []),
			yd.concat(this.options.matchers ?? []).forEach((n) => {
				const [s, i] = n;
				this.addMatcher(s, i);
			});
	}
	...
	convert(t) {
		...
		if (s[At.blotName])
			return new B().insert(n || "", { [At.blotName]: s[At.blotName] });
		if (!e) return new B().insert(n || "", s);
...
`,
			...
			? i.compose(new B().retain(i.length() - 1).delete(1))
			: i;
	}
	normalizeHTML(t) {
		md(t);
	...
	convertHTML(t) {
		...
		const n = e.body,
			s = new WeakMap(),
			[i, o] = this.prepareMatching(n, s);
		return Li(this.quill.scroll, n, i, o, s);
	}
	dangerouslyPasteHTML(t, e) {
		...
		if (typeof t == "string") {
			...
			this.quill.setContents(s, e),
				this.quill.setSelection(0, N.sources.SILENT);
		} else {
			const s = this.convert({ html: e, text: "" });
			this.quill.updateContents(new B().retain(t).concat(s), n),
				this.quill.setSelection(t + s.length(), N.sources.SILENT);
		}
	}
	onCaptureCopy(t) {
		var o, a;
		...
		if (n == null) return;
		const { html: s, text: i } = this.onCopy(n, e);
		(o = t.clipboardData) == null || o.setData("text/plain", i),
			(a = t.clipboardData) == null || a.setData("text/html", s),
			e && xi({ range: n, quill: this.quill });
	}
	normalizeURIList(t) {
		return t
			.split(/\r?\n/)
...
`);
	...
	onCapturePaste(t) {
		...
		if (!n && !s) {
			const v =
				(u = t.clipboardData) == null ? void 0 : u.getData("text/uri-list");
			v && (s = this.normalizeURIList(v));
		}
		const i = Array.from(
			((h = t.clipboardData) == null ? void 0 : h.files) || [],
		);
		if (!n && i.length > 0) {
		...
		if (n && i.length > 0) {
			...
			if (
				v.body.childElementCount === 1 &&
				((p = v.body.firstElementChild) == null ? void 0 : p.tagName) === "IMG"
			) {
				this.quill.uploader.upload(e, i);
				return;
			}
		}
		this.onPaste(e, { html: n, text: s });
	}
	onCopy(t) {
	...
	onPaste(t, e) {
		const { text: n, html: s } = e;
		const i = this.quill.getFormat(t.index),
			o = this.convert({ text: n, html: s }, i);
		bd.log("onPaste", o, { text: n, html: s });
		const a = new B().retain(t.index).delete(t.length).concat(o);
		this.quill.updateContents(a, N.sources.USER),
			this.quill.setSelection(a.length() - t.length, N.sources.SILENT),
			this.quill.scrollSelectionIntoView();
	}
	prepareMatching(t, e) {
		const n = [],
...
function me(r, t) {
	...
	const e = t.query(r);
	return e && e.prototype instanceof Lt
		? !1
		: [
				"address",
				"article",
...
function Ed(r, t) {
	return (
		...
		!me(r.previousElementSibling, t) &&
		!me(r.nextElementSibling, t)
	);
}
...
function qo(r) {
	return r == null
		? !1
		: (wr.has(r) ||
				(r.tagName === "PRE" ? wr.set(r, !0) : wr.set(r, qo(r.parentNode))),
			wr.get(r));
}
function Li(r, t, e, n, s) {
	return t.nodeType === t.TEXT_NODE
		? n.reduce((i, o) => o(t, i, r), new B())
		: t.nodeType === t.ELEMENT_NODE
			? Array.from(t.childNodes || []).reduce((i, o) => {
					let a = Li(r, o, e, n, s);
					return (
						o.nodeType === t.ELEMENT_NODE &&
							((a = e.reduce((u, h) => h(o, u, r), a)),
							(a = (s.get(o) || []).reduce((u, h) => h(o, u, r), a))),
						i.concat(a)
					);
				}, new B())
			: new B();
	...
	return (
		n
			...
			.forEach((a) => {
				...
				(u != null && ((o[u.attrName] = u.value(r)), o[u.attrName])) ||
					((u = vd[a]),
					u != null &&
						(u.attrName === a || u.keyName === a) &&
						(o[u.attrName] = u.value(r) || void 0),
					(u = Tl[a]),
					u != null &&
						(u.attrName === a || u.keyName === a) &&
						((u = Tl[a]), (o[u.attrName] = u.value(r) || void 0)));
			}),
...
function Td(r, t, e) {
	const n = e.query("code-block"),
		s =
			n && "formats" in n && typeof n.formats == "function"
				? n.formats(r, e)
				: !0;
				...
				(o, a) =>
					a.insert
						? a.attributes && typeof a.attributes.indent == "number"
							? o.push(a)
							: o.insert(a.insert, { indent: s, ...(a.attributes || {}) })
						: o,
				new B(),
			);
}
...
`,
		...
		if (
			me(r, e) &&
			(r.childNodes.length > 0 || r instanceof HTMLParagraphElement)
		)
			return t.insert(`
`);
...
function _d(r, t, e) {
	...
	const n = {},
		s = r.style || {};
	return (
		s.fontStyle === "italic" && (n.italic = !0),
		s.textDecoration === "underline" && (n.underline = !0),
		s.textDecoration === "line-through" && (n.strike = !0),
		(((i = s.fontWeight) != null && i.startsWith("bold")) ||
			parseInt(s.fontWeight, 10) >= 700) &&
			(n.bold = !0),
		(t = Object.entries(n).reduce((o, a) => {
			const [u, h] = a;
			return je(o, u, h, e);
		}, t)),
		parseFloat(s.textIndent || 0) > 0 ? new B().insert("	").concat(t) : t
	);
}
function Od(r, t, e) {
	var s, i;
	const n =
		((s = r.parentElement) == null ? void 0 : s.tagName) === "TABLE"
			? r.parentElement
			: (i = r.parentElement) == null
				? void 0
				: i.parentElement;
	if (n != null) {
...
`) &&
		...
		(n = n.replace(/[^\S\u00a0]/g, " ")),
			...
			((r.previousSibling == null &&
				...
				me(r.parentElement, e)) ||
				(r.previousSibling instanceof Element && me(r.previousSibling, e))) &&
				(n = n.replace(/^ /, "")),
			((r.nextSibling == null &&
				r.parentElement != null &&
				me(r.parentElement, e)) ||
				(r.nextSibling instanceof Element && me(r.nextSibling, e))) &&
				(n = n.replace(/ $/, "")),
			(n = n.replaceAll(" ", " "));
	}
	return t.insert(n);
...
class Co extends zt {
	constructor(e, n) {
		...
		q(this, "stack", { undo: [], redo: [] });
		q(this, "currentRange", null);
		this.quill.on(N.events.EDITOR_CHANGE, (s, i, o, a) => {
			s === N.events.SELECTION_CHANGE
				? i && a !== N.sources.SILENT && (this.currentRange = i)
				: s === N.events.TEXT_CHANGE &&
					(this.ignoreChange ||
						(!this.options.userOnly || a === N.sources.USER
							? this.record(i, o)
							: this.transform(i)),
					(this.currentRange = ri(this.currentRange, i)));
		}),
			...
			this.quill.root.addEventListener("beforeinput", (s) => {
				s.inputType === "historyUndo"
					...
					: s.inputType === "historyRedo" && (this.redo(), s.preventDefault());
			});
	}
	change(e, n) {
		...
		const i = this.quill.getContents(),
			o = s.delta.invert(i);
		this.stack[n].push({ delta: o, range: ri(s.range, o) }),
			(this.lastRecorded = 0),
			(this.ignoreChange = !0),
			this.quill.updateContents(s.delta, N.sources.USER),
			(this.ignoreChange = !1),
	...
	transform(e) {
		Ll(this.stack.undo, e), Ll(this.stack.redo, e);
	}
	undo() {
		this.change("undo", "redo");
	}
	restoreSelection(e) {
		if (e.range) this.quill.setSelection(e.range, N.sources.USER);
		else {
			const n = Id(this.quill.scroll, e.delta);
			this.quill.setSelection(n, N.sources.USER);
		}
	}
}
q(Co, "DEFAULTS", { delay: 1e3, maxStack: 100, userOnly: !1 });
function Ll(r, t) {
	let e = t;
	for (let n = r.length - 1; n >= 0; n -= 1) {
		...
		(r[n] = {
			...
			range: s.range && ri(s.range, e),
		}),
			(e = s.delta.transform(e)),
			r[n].delta.length() === 0 && r.splice(n, 1);
	}
}
function Cd(r, t) {
...
`)
			: e.attributes != null
				? Object.keys(e.attributes).some((n) => r.query(n, D.BLOCK) != null)
				: !1;
}
function Id(r, t) {
...
function ri(r, t) {
	if (!r) return r;
	const e = t.transformPosition(r.index),
		n = t.transformPosition(r.index + r.length);
	return { index: e, length: n - e };
}
class Io extends zt {
	constructor(t, e) {
		super(t, e),
			t.root.addEventListener("drop", (n) => {
				...
				if (document.caretRangeFromPoint)
					...
					(s = document.createRange()),
						s.setStart(a.offsetNode, a.offset),
						s.setEnd(a.offsetNode, a.offset);
				}
				const i = s && t.selection.normalizeNative(s);
				if (i) {
					const a = t.selection.normalizedToRange(i);
					(o = n.dataTransfer) != null &&
						o.files &&
						this.upload(a, n.dataTransfer.files);
				}
			});
	}
	upload(t, e) {
...
Io.DEFAULTS = {
	...
	handler(r, t) {
		...
		Promise.all(e).then((n) => {
			...
			this.quill.updateContents(s, R.sources.USER),
				this.quill.setSelection(r.index + n.length, R.sources.SILENT);
		});
	},
};
const Rd = ["insertText", "insertReplacementText"];
class kd extends zt {
	constructor(t, e) {
		super(t, e),
			...
			/Android/i.test(navigator.userAgent) ||
				t.on(N.events.COMPOSITION_BEFORE_START, () => {
					this.handleCompositionStart();
				});
	}
	deleteRange(t) {
		xi({ range: t, quill: this.quill });
	}
	replaceText(t) {
		const e =
			arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "";
		...
		if (e) {
			...
			this.deleteRange(t),
				this.quill.updateContents(
					new B().retain(t.index).insert(e, n),
					N.sources.USER,
				);
	...
	handleBeforeInput(t) {
		if (
			...
			t.defaultPrevented ||
			!Rd.includes(t.inputType)
		)
			return;
		const e = t.getTargetRanges ? t.getTargetRanges()[0] : null;
		if (!e || e.collapsed === !0) return;
		const n = Bd(t);
		if (n == null) return;
		const s = this.quill.selection.normalizeNative(e),
...
function Bd(r) {
	...
	return typeof r.data == "string"
		? r.data
		: (t = r.dataTransfer) != null && t.types.includes("text/plain")
			? r.dataTransfer.getData("text/plain")
			: null;
}
const Md = /Mac/i.test(navigator.platform),
	Dd = 100,
	jd = (r) =>
		!!(
			r.key === "ArrowLeft" ||
...
class Pd extends zt {
	...
	handleArrowKeys() {
		this.quill.keyboard.addBinding({
			...
			shiftKey: null,
			handler(e, n) {
				const { line: s, event: i } = n;
				if (!(s instanceof $t) || !s.uiNode) return !0;
	...
	handleNavigationShortcuts() {
		this.quill.root.addEventListener("keydown", (e) => {
			!e.defaultPrevented && jd(e) && this.ensureListeningToSelectionChange();
		});
	}
	ensureListeningToSelectionChange() {
		if (((this.selectionChangeDeadline = Date.now() + Dd), this.isListening))
			return;
		this.isListening = !0;
		const e = () => {
			(this.isListening = !1),
		...
		document.addEventListener("selectionchange", e, { once: !0 });
	}
...
const Ud = new $d("indent", "ql-indent", {
	scope: D.BLOCK,
	whitelist: [1, 2, 3, 4, 5, 6, 7, 8],
});
class si extends pt {}
q(si, "blotName", "blockquote"), q(si, "tagName", "blockquote");
class ii extends pt {
	static formats(t) {
		return ii.tagName.indexOf(t.tagName) + 1;
	}
}
q(ii, "blotName", "header"),
	q(ii, "tagName", ["H1", "H2", "H3", "H4", "H5", "H6"]);
class Gn extends Me {}
Gn.blotName = "list-container";
Gn.tagName = "OL";
class Vn extends pt {
	static create(t) {
		const e = pt.create();
...
Vn.blotName = "list";
Vn.tagName = "LI";
Gn.allowedChildren = [Vn];
Vn.requiredContainer = Gn;
class Fn extends Jt {
	static create() {
		return Jt.create();
	}
...
q(Fn, "blotName", "bold"), q(Fn, "tagName", ["STRONG", "B"]);
class li extends Fn {}
q(li, "blotName", "italic"), q(li, "tagName", ["EM", "I"]);
class be extends Jt {
	static create(t) {
		const e = Jt.create(t);
		return (
			e.setAttribute("href", be.sanitize(t)),
	...
	static sanitize(t) {
		return Ro(t, be.PROTOCOL_WHITELIST) ? t : be.SANITIZED_URL;
	}
	format(t, e) {
		t !== this.statics.blotName || !e
			? super.format(t, e)
...
q(be, "blotName", "link"),
	q(be, "tagName", "A"),
	q(be, "SANITIZED_URL", "about:blank"),
	q(be, "PROTOCOL_WHITELIST", ["http", "https", "mailto", "tel", "sms"]);
function Ro(r, t) {
...
q(oi, "blotName", "script"), q(oi, "tagName", ["SUB", "SUP"]);
class ai extends Fn {}
q(ai, "blotName", "strike"), q(ai, "tagName", ["S", "STRIKE"]);
class ci extends Jt {}
q(ci, "blotName", "underline"), q(ci, "tagName", "U");
class xr extends vi {
	static create(t) {
...
q(xr, "blotName", "formula"),
	q(xr, "className", "ql-formula"),
	q(xr, "tagName", "SPAN");
const Sl = ["alt", "height", "width"];
class ui extends Lt {
	static create(t) {
		const e = Lt.create(t);
		return typeof t == "string" && e.setAttribute("src", ui.sanitize(t)), e;
	}
	static formats(t) {
		return Sl.reduce(
	...
	static sanitize(t) {
		return Ro(t, ["http", "https", "data"]) ? t : "//:0";
	}
	static value(t) {
...
q(ui, "blotName", "image"), q(ui, "tagName", "IMG");
...
class Lr extends Ct {
	static create(t) {
		...
		return (
			...
			e.setAttribute("src", Lr.sanitize(t)),
			e
		);
	}
	static formats(t) {
...
q(Lr, "blotName", "video"),
	q(Lr, "className", "ql-video"),
	q(Lr, "tagName", "IFRAME");
const In = new Ft("code-token", "hljs", { scope: D.INLINE });
class oe extends Jt {
	static formats(t, e) {
		for (; t != null && t !== e.domNode; ) {
			if (t.classList && t.classList.contains(At.className))
				return Jt.formats(t, e);
			t = t.parentNode;
		}
	}
	constructor(t, e, n) {
		super(t, e, n), In.add(this.domNode, n);
	}
	format(t, e) {
		t !== oe.blotName
			? super.format(t, e)
			: e
				? In.add(this.domNode, e)
				: (In.remove(this.domNode),
					this.domNode.classList.remove(this.statics.className));
	}
	optimize() {
		super.optimize(...arguments), In.value(this.domNode) || this.unwrap();
	}
}
oe.blotName = "code-token";
oe.className = "ql-token";
class qt extends At {
	static create(t) {
		const e = At.create(t);
	...
	replaceWith(t, e) {
		return (
			this.formatAt(0, this.length(), oe.blotName, !1), super.replaceWith(t, e)
		);
	}
}
class kn extends De {
	...
	formatAt(t, e, n, s) {
		n === qt.blotName && (this.forceNext = !0), super.formatAt(t, e, n, s);
	}
	highlight(t) {
		const e =
			arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : !1;
...
`)}
`,
			i = qt.formats(this.children.head.domNode);
		if (e || this.forceNext || this.cachedText !== s) {
			if (s.trim().length > 0 || this.cachedText == null) {
				const o = this.children.reduce((u, h) => u.concat(mo(h, !1)), new B()),
					a = t(s, i);
				o.diff(a).reduce((u, h) => {
					const { retain: p, attributes: v } = h;
					return p
						? (v &&
								Object.keys(v).forEach((f) => {
									[qt.blotName, oe.blotName].includes(f) &&
										this.formatAt(u, p, f, v[f]);
								}),
							u + p)
						: u;
				}, 0);
...
kn.allowedChildren = [qt];
qt.requiredContainer = kn;
qt.allowedChildren = [oe, an, Ut, Ht];
const Fd = (r, t, e) => {
	if (typeof r.versionString == "string") {
		const n = r.versionString.split(".")[0];
		if (parseInt(n, 10) >= 11) return r.highlight(e, { language: t }).value;
	}
	return r.highlight(t, e).value;
};
class ko extends zt {
	static register() {
		N.register(oe, !0), N.register(qt, !0), N.register(kn, !0);
	}
	constructor(t, e) {
	...
	initListener() {
		this.quill.on(N.events.SCROLL_BLOT_MOUNT, (t) => {
			...
			this.options.languages.forEach((n) => {
				const { key: s, label: i } = n;
				const o = e.ownerDocument.createElement("option");
				(o.textContent = i), o.setAttribute("value", s), e.appendChild(o);
			}),
				e.addEventListener("change", () => {
					t.format(qt.blotName, e.value),
						this.quill.root.focus(),
						this.highlight(t, !0);
				}),
				t.uiNode == null &&
					(t.attachUI(e),
					t.children.head && (e.value = qt.formats(t.children.head.domNode)));
		});
	}
	initTimer() {
		let t = null;
	...
	highlight() {
		...
		(t == null ? this.quill.scroll.descendants(kn) : [t]).forEach((i) => {
			i.highlight(this.highlightBlot, e);
		}),
			this.quill.update(N.sources.SILENT),
			n != null && this.quill.setSelection(n, N.sources.SILENT);
	}
	highlightBlot(t) {
		let e =
			arguments.length > 1 && arguments[1] !== void 0 ? arguments[1] : "plain";
...
`,
		...
		return (
			n.classList.add(At.className),
			(n.innerHTML = Fd(this.options.hljs, e, t)),
			Li(
				this.quill.scroll,
				n,
				[
					(s, i) => {
						const o = In.value(s);
						return o
							? i.compose(new B().retain(i.length(), { [oe.blotName]: o }))
							: i;
					},
				],
				[
...
const Mn = class Mn extends pt {
	static create(t) {
		const e = pt.create();
		return (
			t ? e.setAttribute("data-row", t) : e.setAttribute("data-row", Si()), e
		);
	}
	static formats(t) {
...
q(Mn, "blotName", "table"), q(Mn, "tagName", "TD");
const Pt = Mn;
class ae extends Me {
	checkMerge() {
...
q(ae, "blotName", "table-row"), q(ae, "tagName", "TR");
class Yt extends Me {}
q(Yt, "blotName", "table-body"), q(Yt, "tagName", "TBODY");
class un extends Me {
	balanceCells() {
		const t = this.descendants(ae),
			e = t.reduce((n, s) => Math.max(s.children.length, n), 0);
		t.forEach((n) => {
			new Array(e - n.children.length).fill(0).forEach(() => {
				let s;
				n.children.head != null && (s = Pt.formats(n.children.head.domNode));
				const i = this.scroll.create(Pt.blotName, s);
	...
	insertColumn(t) {
		...
		e == null ||
			...
			e.children.forEach((n) => {
				const s = n.children.at(t),
					i = Pt.formats(n.children.head.domNode),
					o = this.scroll.create(Pt.blotName, i);
				n.insertBefore(o, s);
			});
	}
	insertRow(t) {
		...
		const n = Si(),
			s = this.scroll.create(ae.blotName);
		e.children.head.children.forEach(() => {
			const o = this.scroll.create(Pt.blotName, n);
			s.appendChild(o);
		});
...
un.allowedChildren = [Yt];
Yt.requiredContainer = un;
Yt.allowedChildren = [ae];
ae.requiredContainer = Yt;
ae.allowedChildren = [Pt];
Pt.requiredContainer = ae;
function Si() {
	return `row-${Math.random().toString(36).slice(2, 6)}`;
}
class Hd extends zt {
	static register() {
		N.register(Pt), N.register(ae), N.register(Yt), N.register(un);
	}
	constructor() {
	...
	deleteColumn() {
		...
		e != null &&
			(t.deleteColumn(e.cellOffset()), this.quill.update(N.sources.USER));
	}
	deleteRow() {
	...
	deleteTable() {
		...
		t.remove(),
			this.quill.update(N.sources.USER),
			this.quill.setSelection(e, N.sources.SILENT);
	}
	getTable() {
		const t =
			arguments.length > 0 && arguments[0] !== void 0
		...
		if (e == null || e.statics.blotName !== Pt.blotName)
	...
	insertColumn(t) {
		...
		n.insertColumn(o + t), this.quill.update(N.sources.USER);
		let a = s.rowOffset();
		t === 0 && (a += 1),
			this.quill.setSelection(e.index + a, e.length, N.sources.SILENT);
	}
	insertColumnLeft() {
		this.insertColumn(0);
	}
...
`)
				.join("");
			return i.insert(o, { table: Si() });
		}, new B().retain(n.index));
		this.quill.updateContents(s, N.sources.USER),
			this.quill.setSelection(n.index, N.sources.SILENT),
			this.balanceTables();
	}
	listenBalanceCells() {
		this.quill.on(N.events.SCROLL_OPTIMIZE, (t) => {
			t.some((e) =>
				["TD", "TR", "TBODY", "TABLE"].includes(e.target.tagName)
					? (this.quill.once(N.events.TEXT_CHANGE, (n, s, i) => {
...
class _i extends zt {
	constructor(t, e) {
		...
		if ((super(t, e), Array.isArray(this.options.container))) {
			...
			i.setAttribute("role", "toolbar"),
				zd(i, this.options.container),
				(s = (n = t.container) == null ? void 0 : n.parentNode) == null ||
	...
	attach(t) {
		...
		t.addEventListener(n, (s) => {
			...
			if (this.handlers[e] != null) this.handlers[e].call(this, i);
			else if (this.quill.scroll.query(e).prototype instanceof Lt) {
			...
			} else this.quill.format(e, i, N.sources.USER);
			this.update(o);
		}),
	...
	update(t) {
		...
		this.controls.forEach((n) => {
			...
			if (i.tagName === "SELECT") {
				let o = null;
				if (t == null) o = null;
				else if (e[s] == null) o = i.querySelector("option[selected]");
				else if (!Array.isArray(e[s])) {
					let a = e[s];
					typeof a == "string" && (a = a.replace(/"/g, '\\"')),
						(o = i.querySelector(`option[value="${a}"]`));
				}
				o == null
				...
				i.classList.toggle("ql-active", a),
					i.setAttribute("aria-pressed", a.toString());
			} else {
				const o = e[s] != null;
...
function ql(r, t, e) {
	...
	n.setAttribute("type", "button"),
		...
		e != null
			? ((n.value = e), n.setAttribute("aria-label", `${t}: ${e}`))
	...
	Array.isArray(t[0]) || (t = [t]),
		t.forEach((e) => {
			...
			n.classList.add("ql-formats"),
				e.forEach((s) => {
					if (typeof s == "string") ql(n, s);
					else {
						const i = Object.keys(s)[0],
							o = s[i];
						Array.isArray(o) ? Kd(n, i, o) : ql(n, i, o);
					}
				}),
				r.appendChild(n);
		});
			...
			if (r != null)
				if (r.length === 0) {
					...
					Object.keys(t).forEach((e) => {
						this.quill.scroll.query(e, D.INLINE) != null &&
							this.quill.format(e, !1, N.sources.USER);
					});
				} else this.quill.removeFormat(r.index, r.length, N.sources.USER);
		},
		direction(r) {
			const { align: t } = this.quill.getFormat();
			r === "rtl" && t == null
				? this.quill.format("align", "right", N.sources.USER)
				: !r && t === "right" && this.quill.format("align", !1, N.sources.USER),
				this.quill.format("direction", r, N.sources.USER);
		},
		indent(r) {
			const t = this.quill.getSelection(),
			...
			if (r === "+1" || r === "-1") {
				let s = r === "+1" ? 1 : -1;
				e.direction === "rtl" && (s *= -1),
					this.quill.format("indent", n + s, N.sources.USER);
			}
		},
		link(r) {
			r === !0 && (r = prompt("Enter link URL:")),
				this.quill.format("link", r, N.sources.USER);
		},
		list(r) {
			const t = this.quill.getSelection(),
				e = this.quill.getFormat(t);
			r === "check"
				? e.list === "checked" || e.list === "unchecked"
					? this.quill.format("list", !1, N.sources.USER)
					: this.quill.format("list", "unchecked", N.sources.USER)
				: this.quill.format("list", r, N.sources.USER);
		},
	},
};
const Gd =
	...
	Hn = {
		align: { "": Gd, center: Vd, right: Wd, justify: Zd },
		background: Xd,
		blockquote: Yd,
		bold: Qd,
		clean: Jd,
		...
		direction: { "": eg, rtl: ng },
		formula: rg,
		header: { 1: sg, 2: ig, 3: lg, 4: og, 5: ag, 6: cg },
		italic: ug,
		image: hg,
		indent: { "+1": fg, "-1": dg },
		link: gg,
		list: { bullet: pg, check: mg, ordered: bg },
		script: { sub: yg, super: vg },
		strike: Eg,
		table: Ag,
		underline: Ng,
		video: wg,
...
class jr {
	...
	togglePicker() {
		this.container.classList.toggle("ql-expanded"),
			Rl(this.label, "aria-expanded"),
			Rl(this.options, "aria-hidden");
	}
	buildItem(t) {
...
class Do {
	...
	position(t) {
		...
		if (
			(i.right > s.right &&
				((o = s.right - i.right), (this.root.style.left = `${e + o}px`)),
			i.left < s.left &&
				((o = s.left - i.left), (this.root.style.left = `${e + o}px`)),
			i.bottom > s.bottom)
		) {
...
const Lg = [!1, "center", "right", "justify"],
	Sg = [
		"#000000",
		"#e60000",
		"#ff9900",
	...
	_g = [!1, "serif", "monospace"],
	Og = ["1", "2", "3", !1],
	qg = ["small", !1, "large", "huge"];
class Wn extends cn {
	constructor(t, e) {
		super(t, e);
		const n = (s) => {
		...
		Array.from(t).forEach((n) => {
			(n.getAttribute("class") || "").split(/\s+/).forEach((i) => {
				if (i.startsWith("ql-") && ((i = i.slice(3)), e[i] != null))
					if (i === "direction") n.innerHTML = e[i][""] + e[i].rtl;
					else if (typeof e[i] == "string") n.innerHTML = e[i];
					else {
						const o = n.value || "";
	...
	buildPickers(t, e) {
		this.pickers = Array.from(t).map((s) => {
			if (
				...
				(s.querySelector("option") == null && On(s, Lg),
				typeof e.align == "object")
			)
				return new Mo(s, e.align);
			if (
				...
				return (
					s.querySelector("option") == null &&
						On(s, Sg, i === "background" ? "#ffffff" : "#000000"),
					new Bo(s, e[i])
				);
			}
			return (
				s.querySelector("option") == null &&
					(s.classList.contains("ql-font")
						...
						: s.classList.contains("ql-header")
							? On(s, Og)
							: s.classList.contains("ql-size") && On(s, qg)),
				new jr(s)
			);
		});
		const n = () => {
	...
	save() {
		...
		switch (this.root.getAttribute("data-mode")) {
			case "link": {
				...
				this.linkRange
					? (this.quill.formatText(this.linkRange, "link", t, R.sources.USER),
						delete this.linkRange)
					: (this.restoreFocus(), this.quill.format("link", t, R.sources.USER)),
				...
				if (e != null) {
					...
					this.quill.insertEmbed(
						...
						this.root.getAttribute("data-mode") === "formula" &&
							this.quill.insertText(n + 1, " ", R.sources.USER),
...
function Cg(r) {
	...
	return t
		...
		: (t = r.match(/^(?:(https?):\/\/)?(?:www\.)?vimeo\.com\/(\d+)/))
			? `${t[1] || "https"}://player.vimeo.com/video/${t[2]}/`
			: r;
}
function On(r, t) {
	const e = arguments.length > 2 && arguments[2] !== void 0 ? arguments[2] : !1;
	t.forEach((n) => {
		const s = document.createElement("option");
		n === e
			? s.setAttribute("selected", "selected")
			: s.setAttribute("value", String(n)),
			r.appendChild(s);
	});
}
const Ig = [
...
class Po extends jo {
	constructor(t, e) {
		super(t, e),
			this.quill.on(R.events.EDITOR_CHANGE, (n, s, i, o) => {
					...
					if (s != null && s.length > 0 && o === R.sources.USER) {
						...
						if (a.length === 1) {
							...
							const u = a[a.length - 1],
								h = this.quill.getIndex(u),
								p = Math.min(u.length() - 1, s.index + s.length - h),
								v = this.quill.getBounds(new Ie(h, p));
...
class $o extends Wn {
	constructor(t, e) {
		e.modules.toolbar != null &&
			...
			(e.modules.toolbar.container = Ig),
			super(t, e),
			this.quill.container.classList.add("ql-bubble");
	}
	extendToolbar(t) {
		(this.tooltip = new Po(this.quill, this.options.bounds)),
			t.container != null &&
				(this.tooltip.root.appendChild(t.container),
				this.buildButtons(t.container.querySelectorAll("button"), Hn),
				this.buildPickers(t.container.querySelectorAll("select"), Hn));
	}
}
$o.DEFAULTS = ye({}, Wn.DEFAULTS, {
	modules: {
		toolbar: {
			handlers: {
				link(r) {
			...
			this.quill.on(R.events.SELECTION_CHANGE, (e, n, s) => {
				if (e != null) {
					if (e.length === 0 && s === R.sources.USER) {
						const [i, o] = this.quill.scroll.descendant(be, e.index);
						if (i != null) {
							this.linkRange = new Ie(e.index - o, i.length());
							const a = be.formats(i.domNode);
...
class Fo extends Wn {
	constructor(t, e) {
		e.modules.toolbar != null &&
			e.modules.toolbar.container == null &&
			(e.modules.toolbar.container = Rg),
			super(t, e),
	...
	extendToolbar(t) {
		t.container != null &&
			...
			this.buildButtons(t.container.querySelectorAll("button"), Hn),
			this.buildPickers(t.container.querySelectorAll("select"), Hn),
			(this.tooltip = new Uo(this.quill, this.options.bounds)),
			...
			handlers: {
				link(r) {
					if (r) {
						...
						n.edit("link", e);
					} else this.quill.format("link", !1, N.sources.USER);
				},
			},
		},
	},
...
N.register(
	{
		...
		"attributors/class/align": yo,
		"attributors/class/background": Yf,
		"attributors/class/color": Xf,
		"attributors/class/direction": No,
		"attributors/class/font": xo,
		"attributors/class/size": So,
		"attributors/style/align": vo,
		"attributors/style/background": Ni,
		"attributors/style/color": Ai,
		"attributors/style/direction": wo,
		"attributors/style/font": Lo,
		"attributors/style/size": _o,
	},
	!0,
);
N.register(
	{
		"formats/align": yo,
		"formats/direction": No,
		"formats/indent": Ud,
		"formats/background": Ni,
		"formats/color": Ai,
		"formats/font": xo,
		"formats/size": So,
		"formats/blockquote": si,
...
var Pr = class extends Oe.Component {
	constructor(r) {
		super(r),
			(this.editingAreaRef = qi.createRef()),
			(this.containerRef = qi.createRef()),
			...
			(this.selection = null),
			(this.onEditorChange = (e, n, s, i) => {
				var o, a;
				e === "text-change"
					? (o = this.onEditorChangeText) == null ||
						o.call(
							this,
							this.props.useSemanticHTML !== !1
					...
					: e === "selection-change" &&
						((a = this.onEditorChangeSelection) == null ||
							a.call(this, n, i, this.unprivilegedEditor));
			});
		const t = this.isControlled() ? r.value : r.defaultValue;
		this.value = t ?? "";
	}
	validateProps(r) {
		if (Oe.Children.count(r.children) > 1)
			throw new Error(
				"The Quill editing area can only be composed of a single React element.",
			);
		if (Oe.Children.count(r.children)) {
			const t = Oe.Children.only(r.children);
			if ((t == null ? void 0 : t.type) === "textarea")
				throw new Error(
	...
	shouldComponentUpdate(r, t) {
		if (
			(this.validateProps(r),
			!this.editor || this.state.generation !== t.generation)
		)
			return !0;
		if ("value" in r) {
			const e = this.getEditorContents(),
				n = r.value ?? "";
			this.isEqualValue(n, e) || this.setEditorContents(this.editor, n);
		}
		return (
			r.readOnly !== this.props.readOnly &&
				this.setEditorReadOnly(this.editor, r.readOnly),
			[...this.cleanProps, ...this.dirtyProps].some(
				(e) => !ge(r[e], this.props[e]),
			)
		);
	}
	shouldComponentRegenerate(r) {
		return this.dirtyProps.some((t) => !ge(r[t], this.props[t]));
	}
	componentDidMount() {
	...
	componentDidUpdate(r, t) {
		if (this.editor && this.shouldComponentRegenerate(r)) {
			const e = this.editor.getContents(),
				n = this.editor.getSelection();
			(this.regenerationSnapshot = { delta: e, selection: n }),
				this.setState({ generation: this.state.generation + 1 }),
				this.destroyEditor();
		}
		if (
			(this.editor &&
				r.placeholder !== this.props.placeholder &&
			...
			const s = this.editor;
			s.setContents(e), kl(() => this.setEditorSelection(s, n));
		}
	}
	instantiateEditor() {
		this.editor
	...
	destroyEditor() {
		...
		const r = (e = this.props.modules) == null ? void 0 : e.toolbar;
		if (
			!(
				(typeof r == "object" &&
					r &&
			...
			const s =
				(n = this.containerRef.current) == null
					? void 0
					: n.querySelector(".ql-toolbar");
			s && s.remove();
		}
		delete this.editor;
	}
	...
	createEditor(r, t) {
		const e = new N(r, t);
		return (
			t.tabIndex != null && this.setEditorTabIndex(e, t.tabIndex),
			this.hookEditor(e),
			e
		);
	}
	hookEditor(r) {
		(this.unprivilegedEditor = this.makeUnprivilegedEditor(r)),
			r.on("editor-change", this.onEditorChange);
	}
	unhookEditor(r) {
	...
	isEqualValue(r, t) {
		return this.isDelta(r) && this.isDelta(t) ? ge(r.ops, t.ops) : ge(r, t);
	}
	setEditorContents(r, t) {
		this.value = t;
		const e = this.getEditorSelection();
		typeof t == "string"
			? r.setContents(r.clipboard.convert({ html: t }))
			: r.setContents(t),
			kl(() => this.setEditorSelection(r, e));
	}
	setEditorSelection(r, t) {
		if (((this.selection = t), t)) {
			const e = r.getLength();
			(t.index = Math.max(0, Math.min(t.index, e - 1))),
				(t.length = Math.max(0, Math.min(t.length, e - 1 - t.index))),
				r.setSelection(t);
		}
	}
	setEditorTabIndex(r, t) {
		var e;
		(e = r == null ? void 0 : r.scroll) != null &&
			e.domNode &&
			(r.scroll.domNode.tabIndex = t);
	}
	...
	getEditingArea() {
		...
		if (!r) throw new Error("Cannot find element for editing area");
		if (r.nodeType === 3) throw new Error("Editing area cannot be a text node");
		return r;
	}
	renderEditingArea() {
		const { children: r, preserveWhitespace: t } = this.props,
			{ generation: e } = this.state;
		return Oe.Children.count(r)
			? Oe.cloneElement(Oe.Children.only(r), {
					key: e,
					ref: this.editingAreaRef,
				})
			: t
				? Ss.jsx("pre", { ref: this.editingAreaRef }, e)
				: Ss.jsx("div", { ref: this.editingAreaRef }, e);
	}
	render() {
		return Ss.jsx(
			"div",
	...
	onEditorChangeText(r, t, e, n) {
		var i, o;
		if (!this.editor) return;
		const s = this.isDelta(this.value)
			? n.getContents()
			: this.props.useSemanticHTML !== !1
				? n.getSemanticHTML()
				: n.getHTML();
		s !== this.getEditorContents() &&
			((this.lastDeltaChangeSet = t),
			(this.value = s),
			(o = (i = this.props).onChange) == null || o.call(i, r, t, e, n));
	}
	onEditorChangeSelection(r, t, e) {
		...
		ge(r, n) ||
			((this.selection = r),
			(a = (o = this.props).onChangeSelection) == null || a.call(o, r, t, e),
			s
				? (h = (u = this.props).onFocus) == null || h.call(u, r, t, e)
				: i && ((v = (p = this.props).onBlur) == null || v.call(p, n, t, e)));
	}
	focus() {
...
Pr.Quill = N;
Pr.defaultProps = { theme: "snow", modules: {}, readOnly: !1 };
function kl(r) {
